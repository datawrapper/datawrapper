...
define(function (require) {
    ...
    var showChartModal = require('./showChartModal');
    var cft;
    ...
    return function () {
        ...
        $('a.delete').click(function (e) {
            ...
            if (window.confirm(twig.globals.strings.confirm_chart_delete)) {
                httpReq.delete('/api/2/charts/' + id).then(function () {
                    chart.remove();
        ...
        $('a.popup h3')
            ...
            .on('blur', function (e) {
                ...
                if (title.html().trim() !== title.data('old-content')) {
                    httpReq
                        .put('/api/2/charts/' + title.parents('.thumbnail').data('id'), {
                            payload: { title: title.html().trim() }
                        })
                        .then(function () {
                            title.parents('.thumbnail').removeClass('unsaved-change');
                        });
