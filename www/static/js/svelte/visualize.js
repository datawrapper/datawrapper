(function (global, factory) {
  ...
  var file$2 = "node_modules/datawrapper/controls/editor/ChartDescription.html";
  ...
  function create_main_fragment$3(component, ctx) {
    ...
    return {
      c: function create() {
        ...
        addLoc(input3, file$2, 19, 12, 952);
        div1.className = "span2";
        addLoc(div1, file$2, 17, 8, 851);
        label5.className = "control-label";
        addLoc(label5, file$2, 22, 12, 1137);
        ...
        addLoc(input4, file$2, 23, 12, 1205);
        div2.className = "span2";
        addLoc(div2, file$2, 21, 8, 1105);
        div3.className = "row";
        addLoc(div3, file$2, 16, 4, 825);
        label6.className = "control-label";
        addLoc(label6, file$2, 28, 8, 1394);
        ...
        addLoc(input5, file$2, 29, 8, 1477);
        div4.className = "chart-byline";
        addLoc(div4, file$2, 27, 4, 1359);
  ...
  function oncreate() {
    ...
    var _dw$backend$hooks$cal = dw.backend.hooks.call(key, [chart]),
        results = _dw$backend$hooks$cal.results;

    this.set({
      blocks: results.sort(function (a, b) {
  ...
  function create_main_fragment$5(component, ctx) {
    ...
    return {
      ...
      m: function mount(target, anchor) {
        chartdescription._mount(target, anchor);
      ...
      p: noop,
      d: function destroy(detach) {
        chartdescription.destroy(detach);
  ...
  var file$5 = "visualize/ChartPicker.html";
  ...
  function create_main_fragment$a(component, ctx) {
    ...
    return {
      c: function create() {
        ...
        addLoc(div0, file$5, 2, 8, 91);
        div1.className = "vis-archive-select";
        addLoc(div1, file$5, 11, 8, 408);
        addLoc(b, file$5, 15, 11, 560);
        addLoc(p, file$5, 15, 8, 557);
        div2.className = "vis-selector-unfolded";
        addLoc(div2, file$5, 1, 4, 47);
        div3.className = "section select-visualization";
        addLoc(div3, file$5, 0, 0, 0);
      },
      m: function mount(target, anchor) {
  ...
  var file$6 = "visualize/Loading.html";
