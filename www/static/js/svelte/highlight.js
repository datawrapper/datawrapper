	...
	function create_main_fragment(component, ctx) {
	  ...
	  return {
	    c: function create() {
	      ...
	      addLoc(label, file, 1, 4, 67);
	      option.__value = "---";
	      option.value = option.__value;
	      addLoc(option, file, 4, 12, 269);
	      ...
	      addLoc(select, file, 3, 8, 179);
	      addLoc(div0, file, 2, 4, 165);
	      p.className = "highlighted-series";
	      setStyle(p, "margin-top", "5px");
	      addLoc(p, file, 10, 4, 492);
