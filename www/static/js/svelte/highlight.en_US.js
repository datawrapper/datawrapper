...
function create_main_fragment(state, component) {
	var div, label, raw_value = "Highlight the most import elements (optional)", text, div_1, select, option, text_1, raw_1_value = "select element", raw_1_before, raw_1_after, text_2, select_updating = false, text_4, p;
