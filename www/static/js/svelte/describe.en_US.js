...
function stats(validValues, format) {
    ...
    return [
        ...
        {x:xmean, label: format(xmean), name: "Mean"},
...
function tooltip(bin, i, bins, len) {
    const tt = i === 0 ? "$1 values ($2) are smaller than $4" :
        i == bins.length-1 ? "$1 values ($2) are ≥ $3" :
        "$1 values ($2) are ≥ $3 and < $4";
...
function create_main_fragment$4(component, state) {
	var h3, text_value = "Value distribution (histogram)", text, text_1, svg, g, g_1, each_anchor, g_1_transform_value, g_2, g_transform_value, text_2, ul, each_2_anchor, text_3, p, raw_value = "The chart above shows how the values in the selected column are distributed. <a target='_blank' href='https://academy.datawrapper.de/article/136-histogram-min-max-median-mean'>Learn more...</a>";
...
function create_if_block_1$1(component, state) {
	var li, text_value = "Invalid", text, text_1, tt, text_2, text_3, text_4_value = pct(state.NAs/state.values.length), text_4, text_5;
...
function create_main_fragment$6(component, state) {
	var div, div_1, div_2, div_3, text, hr, text_1, div_4, a, i, text_2, text_3_value = "Back", text_3, text_4, a_1, text_5_value = "Proceed", text_5, text_6, i_1, text_10, div_5, div_6, raw_value = "Click on table header<br>to edit column properties", raw_after, text_11, img, text_13, div_7, div_8, div_9, button, raw_1_value = "Sort view by", raw_1_after, text_14, span, text_16, ul, li, a_2, raw_2_value = "No sorting", li_class_value, text_19, div_10, i_2, text_20, div_11, input, input_updating = false, input_placeholder_value, input_class_value, text_21, div_11_class_value, text_23, text_26, handsontable_updating = {}, text_27, div_12, button_1, img_1, text_28, text_29_value = "Swap rows and columns (transpose)", text_29, text_30, button_2, i_3, text_31, text_32_value = "Add column", text_32, text_33, text_34, button_3, i_4, text_35, text_36_value = "Revert changes", text_36, text_37, button_3_class_value;
...
function create_if_block_5(component, state) {
	var h3, text_value = "Show/hide multiple columns", text, text_1, ul, li, button, i, text_2, text_3_value = "Show selected columns", text_3, li_1, button_1, i_1, text_6, text_7_value = "Hide selected columns", text_7;
...
function create_if_block_6(component, state) {
	var h3, text_value = "Make sure the data looks right", text, text_1, p, text_2_value = "Please make sure that Datawrapper interprets your data correctly. In the table columns should be shown in blue, dates in green and text in black.", text_2, text_3, checkbox_updating = {}, text_4, h4, text_5_value = "Output locale", text_5, text_6, p_1, text_7_value = "Defines decimal and thousand separators as well as translation of month and weekday names.", text_7, text_8, select, select_updating = false;
