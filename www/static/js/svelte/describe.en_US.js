...
function create_main_fragment$2(state, component) {
	...
	component.root._beforecreate.push(function() {
		...
		handsontable_updating = { data: true, transpose: true, firstRowIsHeader: true, search: true };
		component._set(newState);
		handsontable_updating = {};
	});
	...
	return {
		c: function create() {
			...
			div_5.innerHTML = "<button class=\"btn\"><i class=\"fa fa-chevron-up\"></i></button>\n                  <button class=\"btn\"><i class=\"fa fa-chevron-down\"></i></button>";
			text_11 = createText("\n\n            ");
