(function (global, factory) {
	...
	function create_main_fragment$1(component, ctx) {
	  ...
	  return {
	    c: function create() {
	      ...
	      div1.className = "sub";
	      addLoc(div1, file, 173, 12, 7860);
	      button1.className = "button btn btn-got-it";
	      addLoc(button1, file, 175, 12, 7951);
	      div2.className = "jumbo-text";
	      addLoc(div2, file, 170, 8, 7760);
	      div3.className = "signup-confirm hidden";
	      addLoc(div3, file, 169, 4, 7716);
	...
	function create_if_block_14(component, ctx) {
	  ...
	  return {
	    c: function create() {
	      ...
	      addLoc(div2, file, 52, 16, 2486);
	      div3.className = "svelte-1x6vgwk";
	      addLoc(div3, file, 44, 12, 2029);
	...
	function create_if_block_16(component, ctx) {
	  ...
	  return {
	    c: function create() {
	      ...
	      addLoc(button, file, 47, 20, 2142);
	      setStyle(div, "padding-bottom", "10px");
	      div.className = "svelte-1x6vgwk";
	      addLoc(div, file, 46, 16, 2088);
	    },
	    m: function mount(target, anchor) {
	      insert(target, div, anchor);
	      append(div, button);
	...
	} // (66:12) {#if signupWithoutPassword}
	...
	function create_if_block_13(component, ctx) {
	  ...
	  return {
	    c: function create() {
	      ...
	      addLoc(p0, file, 66, 12, 3121);
	      addLoc(p1, file, 69, 12, 3201);
	    },
	    m: function mount(target, anchor) {
	...
	} // (83:18) {#if !signupSuccess || !signupWithoutPassword}
	...
	} // (90:20) {#if !signupWithoutPassword}
	...
	function create_if_block_6(component, ctx) {
	  ...
	  return {
	    c: function create() {
	      ...
	      addLoc(label0, file, 91, 24, 4242);
	      setStyle(div0, "width", "270px");
	      div0.className = "svelte-1x6vgwk";
	      addLoc(div0, file, 109, 24, 5054);
	...
	} // (93:24) {#if showPasswordAsClearText}
	...
	} // (140:18) {#if signupWithoutPassword && !signupSuccess}
	...
	} // (157:4) {#if !noSignin && alternativeSignIn.length}
	...
	function create_if_block$1(component, ctx) {
	  ...
	  return {
	    c: function create() {
	      ...
	      div1 = createElement("div");
	      div0.className = "svelte-1x6vgwk";
	      addLoc(div0, file, 158, 8, 7336);
	      div1.className = "svelte-1x6vgwk";
	      addLoc(div1, file, 163, 8, 7623);
	      div2.className = "alternative-signin svelte-1x6vgwk";
	      addLoc(div2, file, 157, 4, 7295);
	    },
	    m: function mount(target, anchor) {
	      insert(target, div2, anchor);
	      append(div2, div0);
	...
	} // (160:53) {#each alternativeSignIn as signin}
