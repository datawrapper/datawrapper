(function (global, factory) {
	...
	function create_if_block_14(component, ctx) {
		var div4, h3, raw0_value = __("login / login / headline"), text0, p, raw1_value = __("login / login / intro"), text1, text2, text3, form, div1, div0, label, text4_value = __('email'), text4, text5, input, input_updating = false, text6, text7, text8, div3, text9, div2, div4_class_value;
