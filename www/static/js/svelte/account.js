(function (global, factory) {
	...
	var file$4 = "node_modules/datawrapper/controls/Text.html";
	...
	function create_main_fragment$4(component, ctx) {
		...
		var if_block2 = (ctx.disabled && ctx.disabled_msg) && create_if_block$4(component, ctx);
		...
		return {
			c: function create() {
				...
				addLoc(input, file$4, 5, 8, 207);
				div.className = "flex svelte-lyrczp";
				addLoc(div, file$4, 1, 4, 99);
			},
	...
	function create_if_block$4(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(div0, file$4, 14, 4, 474);
				addLoc(div1, file$4, 13, 0, 447);
			},
	...
	var file$5 = "node_modules/datawrapper/controls/BaseSelect.html";
	...
	function create_main_fragment$5(component, ctx) {
		...
		var if_block1 = (ctx.optgroups.length) && create_if_block$5(component, ctx);
	...
	function create_each_block$2(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(optgroup, file$5, 4, 4, 269);
			},
	...
	var file$6 = "account/MyTeams.html";
	...
	function create_main_fragment$6(component, ctx) {
		...
		var if_block2 = (ctx.teams.length > 0) && create_if_block$6(component, ctx);
		...
		return {
			c: function create() {
				...
				text2 = createText(" ");
				if (if_block2) { if_block2.c(); }
				addLoc(h2, file$6, 0, 0, 0);
				div.className = "row";
				addLoc(div, file$6, 58, 0, 2134);
			},
			...
			p: function update(changed, ctx) {
				...
				if (ctx.teams.length > 0) {
					if (if_block2) {
						...
						if_block2 = create_if_block$6(component, ctx);
						if_block2.c();
	...
	function create_if_block_6$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(p, file$6, 3, 0, 63);
				addLoc(th0, file$6, 8, 12, 176);
				addLoc(th1, file$6, 12, 12, 333);
				addLoc(th2, file$6, 13, 12, 393);
				addLoc(th3, file$6, 14, 12, 454);
				addLoc(th4, file$6, 15, 12, 516);
				addLoc(tr, file$6, 7, 8, 159);
				addLoc(thead, file$6, 6, 4, 143);
				addLoc(tbody, file$6, 18, 4, 596);
				table.className = "table";
				addLoc(table, file$6, 5, 0, 117);
			},
	...
	function create_else_block_2$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(i, file$6, 45, 21, 1881);
				a.href = a_href_value = "/team/" + ctx.team.id + "/settings#deleteTeam";
				a.className = "btn btn-small btn-danger";
				addLoc(a, file$6, 44, 16, 1781);
			},
			...
			p: function update(changed, ctx) {
				if ((changed.teams) && a_href_value !== (a_href_value = "/team/" + ctx.team.id + "/settings#deleteTeam")) {
					a.href = a_href_value;
				}
			},
	...
	function create_each_block$3(component, ctx) {
		...
		return {
			c: function create() {
				...
				if_block4.c();
				addLoc(td0, file$6, 21, 12, 699);
				addLoc(td1, file$6, 30, 12, 1101);
				a.href = a_href_value = "/team/" + ctx.team.id;
				addLoc(a, file$6, 31, 16, 1166);
				addLoc(td2, file$6, 31, 12, 1162);
				addLoc(td3, file$6, 32, 12, 1227);
				addLoc(td4, file$6, 38, 12, 1501);
				toggleClass(tr, "current", ctx.team.id === ctx.currentTeam);
				addLoc(tr, file$6, 20, 8, 642);
			},
	...
	function create_if_block_2$3(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(h3, file$6, 61, 8, 2207);
				div.className = "span5";
				addLoc(div, file$6, 60, 4, 2179);
			},
	...
	function create_else_block$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(button0, file$6, 85, 8, 3243);
				addListener(button1, "click", click_handler_2);
				button1.className = "btn";
				addLoc(button1, file$6, 89, 8, 3640);
			},
	...
	function create_if_block_3$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(p, file$6, 64, 12, 2322);
				i.className = "fa fa-plus fa-fw";
				addLoc(i, file$6, 68, 16, 2531);
				addListener(button, "click", click_handler_1);
				button.className = "btn btn-large";
				toggleClass(button, "btn-primary", !ctx.teams.length);
				addLoc(button, file$6, 67, 12, 2416);
				div.className = "hed svelte-t3x94h";
				addLoc(div, file$6, 63, 8, 2292);
			},
	...
	function create_if_block_5$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(input, file$6, 81, 12, 3127);
			},
	...
	// (87:58)  &nbsp;<i class="fa fa-spinner fa-spin"></i> {:then}
	...
	function create_if_block$6(component, ctx) {
		...
		return {
			c: function create() {
				...
				formblock._fragment.c();
				h3.className = "svelte-t3x94h";
				addLoc(h3, file$6, 94, 8, 3809);
				addLoc(p, file$6, 95, 8, 3875);
				div0.className = "flex";
				addLoc(div0, file$6, 97, 12, 4026);
				div1.className = "span5";
				addLoc(div1, file$6, 93, 4, 3781);
			},
	...
	// (101:62)  &nbsp;<i class="fa fa-spinner fa-spin"></i>                 {:then}
	...
	function create_main_fragment$7(component, ctx) {
		var div, h1, text0_value = __('account / settings'), text0, text1, text2, navtabs_updating = {};
	...
	function create_each_block$4(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(b, file$7, 4, 47, 188);
				a.href = a_href_value = "/organization-invite/" + ctx.team.token;
				a.className = "btn btn-primary";
				addLoc(a, file$7, 5, 8, 248);
				div.className = "alert alert-info";
				addLoc(div, file$7, 3, 4, 110);
			},
	...
	var main = { App: App, data: data$8, store: store };
