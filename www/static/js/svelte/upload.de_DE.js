...
function oncreate$1() { app$1 = this; }
function create_main_fragment$2(component, state) {
	var div, div_1, div_2, div_3, h3, text_1, ul, text_2, switch_instance_updating = {}, text_5, div_4, switch_instance_1_updating = {}, text_6, div_5, a, text_7_value = "Weiter", text_7, text_8, i;
	...
	return {
		...
		h: function hydrate() {
			ul.className = "import-methods svelte-g7di00";
...
function create_each_block$1(component, state) {
	...
	var if_block = (btn.isFileUpload) && create_if_block(component, state);
	...
	return {
		...
		h: function hydrate() {
			i.className = i_class_value = "" + btn.icon + " svelte-g7di00";
			span.className = "svelte-g7di00";
			label.className = "svelte-g7di00";
			addListener(li, "click", click_handler);
			li.className = li_class_value = "action " + (state.active==btn.id?'active':'') + " svelte-g7di00";
		...
		p: function update(changed, state) {
			...
			if ((changed.buttons) && i_class_value !== (i_class_value = "" + btn.icon + " svelte-g7di00")) {
			...
			if ((changed.active || changed.buttons) && li_class_value !== (li_class_value = "action " + (state.active==btn.id?'active':'') + " svelte-g7di00")) {
...
function create_if_block(component, state) {
	...
	return {
		...
		h: function hydrate() {
			...
			input.className = "file-upload svelte-g7di00";
...
function App(options) {
	...
	var self = this;
	var _oncreate = function() {
		var changed = { buttons: 1, active: 1, UploadHelp: 1, chartData: 1, readonly: 1, datasets: 1, Upload: 1 };
