...
function create_main_fragment$1(component, state) {
	var p, text_value = "Markiere die Datentabelle in Excel oder LibreOffice (einschließlich der ersten Zeile mit den Spaltentiteln), und fügen ihn in das nebenstehende Textfeld. Alternativ kannst du auch eine CSV-Datei hochladen.", text, text_1, div, p_1, text_2_value = "Wenn du Datawrapper nur ausprobieren möchtest, kannst du eine Beispiel-Datensatz aus dieser Liste auswählen:", text_2, text_3, select, option, text_4_value = "Beispiel-Datensatz auswählen", text_4, select_updating = false;
...
const coreUploads = [{
    ...
    longTitle: "Daten kopieren und einfügen",
    icon: 'im im-copy',
...
function create_main_fragment$2(component, state) {
	var div, text, div_1, div_2, div_3, h3, raw_value = "Wie möchtest du deine Daten hochladen?", text_1, ul, text_2, h4, text_3_value = state.active.longTitle || state.active.title, text_3, text_4, switch_instance_updating = {}, text_7, div_4, switch_instance_1_updating = {}, text_8, div_5, a, text_9_value = "Weiter", text_9, text_10, i, div_1_style_value;
	...
	return {
		...
		p: function update(changed, state) {
			...
			if ((changed.active) && text_3_value !== (text_3_value = state.active.longTitle || state.active.title)) {
			...
			if (switch_value_1 !== (switch_value_1 = state.MainPanel)) {
				...
				if (switch_value_1) {
					...
					switch_instance_1._mount(div_4, text_8);
				}
			}
...
function create_if_block(component, state) {
	var div, raw_value = "Ziehe deine CSV-Datei hier her zum Hochladen...";
