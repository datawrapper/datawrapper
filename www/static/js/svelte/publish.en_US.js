...
function encapsulateStyles(node) {
	setAttribute(node, "svelte-562457692", "");
}
...
function create_if_block_8(state, component) {
	var div, div_1, i, text, div_2, div_3, b, raw_value = "Share via URL", text_1, div_4, label, input, text_2, raw_1_value = "fullscreen", raw_1_before, text_3, text_6, div_5, a, text_7, text_10, div_6, span, text_12, div_7, raw_2_value = "The <b>normal size</b> URL displays the chart exactly the size you created it, and is useful for sharing on social media sites. The <b>fullscreen</b> URL will show your chart sized to fill the entire browser window.", text_16, div_8, i_1, text_17, div_9, div_10, b_1, raw_3_value = "Copy Embed code", text_18, div_11, text_21, div_12, input_1, text_22, button, i_2, text_23, text_24_value = "copy", text_24, text_25, div_13, text_26_value = "Embed code was copied to clipboard!", text_26, div_13_class_value, text_30, div_14, span_1, text_32, div_15, raw_4_value = "Copy and paste this HTML code into your website or CMS to embed your chart. The <b>responsive iframe</b> automatically adjusts its height to fit both headline and chart on different devices.", raw_4_after, text_33;
