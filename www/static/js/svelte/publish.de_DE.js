...
function encapsulateStyles(node) {
	setAttribute(node, "svelte-2344042230", "");
}
...
function create_if_block_8(state, component) {
	var div, div_1, i, text, div_2, div_3, b, raw_value = "Diagramm per URL teilen", text_1, label, input, text_2, raw_1_value = "Normale Größe", raw_1_before, text_3, label_1, input_1, text_4, raw_2_value = "Vollbild", raw_2_before, text_6, div_4, a, text_7, text_10, div_5, span, text_12, div_6, raw_3_value = "Bei <b>normale Größe</b> wird das Diagramm genau so dargestellt, wie es erstellt wurde. Bei <b>Vollbild</b> füllt das Diagramm das komplette Browser-Fenser.", text_16, div_7, i_1, text_17, div_8, div_9, b_1, raw_4_value = "Einbett-Code kopieren", text_18, div_10, text_21, div_11, input_2, text_22, button, i_2, text_23, text_24_value = "kopieren", text_24, text_25, div_12, text_26_value = "Der Code wurde kopiert!", text_26, div_12_class_value, text_30, div_13, span_1, text_32, div_14, raw_5_value = "Kopiere diesen HTML Code in deine Webseite oder CMS, um dein Diagramm einzubetten. Der <b>responsive</b> Iframe passt sich automatisch der Höhe der Überschrift auf verschiedenen Geräten an.", raw_5_after, text_33;
