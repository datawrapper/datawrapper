...
function shareUrl(shareurl_type, chart, plugin_shareurls) {
...
function encapsulateStyles(node) {
	setAttribute(node, "svelte-4152209952", "");
}

function create_main_fragment(state, component) {
	var h2, raw_value = "Veröffentlichen zum Teilen & Einbetten", text, text_1, button, text_3, text_4, text_5, text_6, text_7, if_block_6_anchor;
...
function create_if_block_1(state, component) {
	var p, raw_value = "Um dein Diagramm zu <b>teilen</b> oder auf deiner <b>Website oder CMS einzubetten</b> musst du es veröffentlichen. Es wird nur für Personen sichtbar sein, die die URL des Diagramms kennen.";
...
function create_if_block_2(state, component) {
	var span, i, i_class_value, text, text_1_value = "Erneut veröffentlichen", text_1;
...
function create_if_block_3(state, component) {
	var span, i, i_class_value, text, text_1_value = "Veröffentlichen", text_1;
...
// (52:20) {{#each plugin_shareurls as tpl}}
...
// (75:20) {{#each embed_templates as tpl}}
...
// (91:16) {{#each embed_templates.slice(2) as tpl}}
...
function create_if_block_8(state, component) {
	var div, div_1, i, text, div_2, div_3, b, raw_value = "Diagramm per URL teilen", text_1, div_4, label, input, text_2, raw_1_value = "Vollbild", raw_1_before, text_3, text_6, div_5, a, text_7, text_10, div_6, span, text_12, div_7, raw_2_value = "Bei <b>normale Größe</b> wird das Diagramm genau so dargestellt, wie es erstellt wurde. Bei <b>Vollbild</b> füllt das Diagramm das komplette Browser-Fenser.", text_16, div_8, i_1, text_17, div_9, div_10, b_1, raw_3_value = "Einbett-Code kopieren", text_18, div_11, text_21, div_12, input_1, text_22, button, i_2, text_23, text_24_value = "kopieren", text_24, text_25, div_13, text_26_value = "Der Code wurde kopiert!", text_26, div_13_class_value, text_30, div_14, span_1, text_32, div_15, raw_4_value = "Kopiere diesen HTML Code in deine Webseite oder CMS, um dein Diagramm einzubetten. Der <b>responsive</b> Iframe passt sich automatisch der Höhe der Überschrift auf verschiedenen Geräten an.", raw_4_after, text_33;
	...
	return {
		c: function create() {
			...
			raw_4_after = createElement('noscript');
			text_33 = createText("\n                ");
		...
		m: function mount(target, anchor) {
			...
			b_1.innerHTML = raw_3_value;
			appendNode(text_18, div_10);
			...
			appendNode(text_22, div_12);
			appendNode(button, div_12);
			appendNode(i_2, button);
			appendNode(text_23, button);
			appendNode(text_24, button);
			appendNode(text_25, div_12);
			appendNode(div_13, div_12);
			appendNode(text_26, div_13);
			appendNode(text_30, div_8);
			appendNode(div_14, div_8);
			appendNode(span_1, div_14);
			appendNode(text_32, div_14);
			appendNode(div_15, div_14);
			appendNode(raw_4_after, div_15);
			raw_4_after.insertAdjacentHTML("beforebegin", raw_4_value);
...
function App(options) {
	...
	this._recompute({ shareurl_type: 1, chart: 1, plugin_shareurls: 1, embed_type: 1 }, this._state);
...
App.prototype._recompute = function _recompute(changed, state) {
	if (changed.shareurl_type || changed.chart || changed.plugin_shareurls) {
		if (differs(state.shareUrl, (state.shareUrl = shareUrl(state.shareurl_type, state.chart, state.plugin_shareurls)))) changed.shareUrl = true;
	}
