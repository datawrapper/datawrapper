(function (global, factory) {
	...
	const coreUploads = [{
	    ...
	    onFileUpload(event) {
	        ...
	        if (file.type.substr(0,5) == 'text/') {
	            ...
	            app$1.set({error: 'This is not a text file!'});
	        }
	    },
	    action() {}
	}];
	...
	function create_main_fragment$2(component, state) {
		var div, text, div_1, div_2, div_3, text_1, h3, raw_value = __('upload / title'), text_2, ul, text_3, h4, text_4_value = state.active.longTitle || state.active.title, text_4, text_5, switch_instance_updating = {}, text_8, div_4, switch_instance_1_updating = {}, text_9, div_5, a, text_10_value = __("Proceed"), text_10, text_11, i, div_1_style_value;

		var if_block = (state.dragover) && create_if_block(component, state);

		var if_block_1 = (state.error) && create_if_block_1(component, state);
	...
	function create_each_block$1(component, state) {
		...
		var if_block = (btn.isFileUpload) && create_if_block_2(component, state);
	...
	function App(options) {
		...
		var self = this;
		var _oncreate = function() {
			var changed = { dragover: 1, error: 1, buttons: 1, active: 1, Sidebar: 1, chartData: 1, readonly: 1, datasets: 1, MainPanel: 1 };
