...
var methods$4 = {
    sort: function sort(orderBy) {
        ...
        window.history.replaceState(state, '', ("/admin/users?" + (queryString_3(state))));
        this.loadUserList();
    },
...
function create_main_fragment$4(component, state) {
	var div, text, table, text_1, text_3;
	...
	var if_block_1 = (state.loader) && create_if_block_1$2(component, state);

	var if_block_2 = (state.paginationItems.length > 0) && create_if_block_2(component, state);
...
// (21:4) {#if paginationItems.length > 0}
...
function UserAdmin(options) {
	...
	var _oncreate = function() {
		var changed = { limit: 1, offset: 1, total: 1, userDetails: 1, columnHeaders: 1, loader: 1, list: 1, paginationItems: 1, currentPageNum: 1 };
		oncreate.call(self);
