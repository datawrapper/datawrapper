...
assign(UserAdminTableHeader.prototype, methods);
...
assign(UserAdminRow.prototype, methods$1);
...
assign(UserAdminPagination.prototype, methods$2);
...
var BASE_URL = '//datawrapper.local:3000/admin/users';
...
function create_main_fragment$3(component, state) {
	...
	var if_block = (state.loader) && create_if_block$2(component, state);
...
// (17:4) {#if paginationItems.length > 0}
...
function UserAdmin(options) {
	...
	var _oncreate = function() {
		var changed = { limit: 1, offset: 1, total: 1, columnHeaders: 1, loader: 1, list: 1, paginationItems: 1, currentPageNum: 1 };
		oncreate.call(self);
...
assign(UserAdmin.prototype, methods$3);
