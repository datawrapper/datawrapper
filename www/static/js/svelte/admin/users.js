...
function create_if_block(component, state) {
	var div, code, text, text_1_value = state.user.resetPasswordToken, text_1;
...
function UserDetails(options) {
	...
	var _oncreate = function() {
		var changed = { user: 1, roleOptions: 1, updates: 1, createdAtFormatted: 1, resetPasswordToken: 1 };
		oncreate.call(self);
