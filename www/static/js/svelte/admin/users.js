...
function create_main_fragment(component, state) {
	var h1, text, text_1, text_2, text_3, button, text_5, hr, text_6, ul;
...
function create_each_block(component, state) {
	...
	return {
		...
		p: function update(changed, state) {
			...
			if ((changed.users) && text_value !== (text_value = user.email)) {
...
function UserAdmin(options) {
	...
	if (!('count' in this._state)) { console.warn("<UserAdmin> was created without expected data property 'count'"); }
