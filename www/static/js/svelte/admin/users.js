...
function create_if_block_1$1(component, state) {
	var td, input, input_updating = false, text_1, td_1, input_1, input_1_updating = false, text_3, td_2, select, text_5, td_3, text_7, td_4, a, text_8_value = state.user.chartCount, text_8, a_href_value, text_10, td_5, button, i, i_title_value, text_12, button_1, i_1, i_1_title_value;

	function input_input_handler() {
		var state = component.get();
		input_updating = true;
		state.user.name = input.value;
		component.set({ user: state.user });
...
var methods$4 = {
    ...
    saveUser: function saveUser(ref) {
        ...
        var requestBody = JSON.stringify({ name: name, email: email }, function (key, value) {
            if (value === null) {
