...
function create_main_fragment(component, state) {
	var section, h1, text_value = state.user.id, text, text_1, text_2_value = state.user.email, text_2;
...
function create_main_fragment$2(component, state) {
	...
	return {
		...
		h: function hydrate() {
			a.href = a_href_value = "/admin/users/?currentUser=" + state.user.id;
			td.className = "id out";
		...
		p: function update(changed, state) {
			...
			if ((changed.user) && a_href_value !== (a_href_value = "/admin/users/?currentUser=" + state.user.id)) {
				a.href = a_href_value;
			}
...
assign(UserAdminRow.prototype, methods$2);
