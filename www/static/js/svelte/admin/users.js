...
function create_if_block_1(component, state) {
	var td, text, td_1, select, option, text_1, option_1, text_2, option_2, text_3, option_3, text_4, text_6, td_2, text_8, td_3, text_10, td_4, text_12, td_5, button, text_13, button_1;
	...
	return {
		c: function create() {
			...
			text_1 = createText("Nicht aktiviert");
			option_1 = createElement("option");
			text_2 = createText("Editor");
			option_2 = createElement("option");
			text_3 = createText("Administrator");
			option_3 = createElement("option");
			text_4 = createText("Grafik-Redakteur");
			text_6 = createText("\n\t");
			td_2 = createElement("td");
		...
		h: function hydrate() {
			td.className = "email";
			option.__value = "pending";
			option.value = option.__value;
			option_1.__value = "editor";
			option_1.value = option_1.__value;
			option_2.__value = "admin";
			option_2.value = option_2.__value;
			option_2.selected = "selected";
			option_3.__value = "graphic-editor";
		...
		m: function mount(target, anchor) {
			...
			appendNode(text_2, option_1);
			appendNode(option_2, select);
			appendNode(text_3, option_2);
			appendNode(option_3, select);
			appendNode(text_4, option_3);
