...
var methods$1 = {
    publish: function publish() {
        ...
        window.chart
            ...
            .then(function (d) {
                // publish chart
                postJSON(("/api/charts/" + (chart.id) + "/publish"), null, function (res) {
                    if (res.status === 'ok') {
    ...
    updateStatus: function updateStatus() {
        ...
        var chart = ref.chart;
        fakeProgress += 0.05;
        getJSON(("/api/charts/" + (chart.id) + "/publish/status"), function (res) {
            if (res) {
...
function create_main_fragment$1(component, state) {
	var text, button, button_class_value, text_2, text_3, text_4, text_5, text_6, text_7, div, h2, raw_value = __('publish / share-embed'), text_8, div_1, i, text_9, div_2, div_3, b, raw_1_value = __('publish / share-url'), text_10, div_4, label, input, text_11, raw_2_value = __('publish / share-url / fullscreen'), raw_2_before, text_13, text_16, div_5, a, text_17, text_20, text_21, div_6, raw_3_value = __('publish / help / share-url'), text_22, text_24, div_7, i_1, text_25, div_8, div_9, b_1, raw_4_value = __('publish / embed'), text_26, div_10, text_29, div_11, input_1, text_30, button_1, i_2, text_31, text_32_value = __('publish / copy'), text_32, text_33, div_12, text_34_value = __('publish / copy-success'), text_34, div_12_class_value, text_38, text_39, div_13, raw_5_value = __('publish / embed / help'), raw_5_after, text_40, text_42, div_class_value;
	...
	return {
		c: function create() {
			...
			a = createElement("a");
			text_17 = createText(state.shareUrl);
			text_20 = createText("\n        ");
			text_21 = createText("\n            ");
			...
			text_34 = createText(text_34_value);
			text_38 = createText("\n        ");
			text_39 = createText("\n            ");
		...
		h: function hydrate() {
			...
			button.className = button_class_value = "btn-publish btn btn-primary btn-large " + (state.published?'':'btn-first-publish') + " svelte-1ee9woc";
			...
			div_4.className = "embed-options svelte-1ee9woc";
			div_3.className = "h";
			a.target = "_blank";
			...
			div_10.className = "embed-options svelte-1ee9woc";
			div_9.className = "h";
			...
			button_1.title = "copy";
			div_12.className = div_12_class_value = "copy-success " + (state.copy_success ? 'show':'') + " svelte-1ee9woc";
		...
		m: function mount(target, anchor) {
			...
			appendNode(text_33, div_11);
			appendNode(div_12, div_11);
			appendNode(text_34, div_12);
			appendNode(text_38, div_7);
			appendNode(text_39, help_1._slotted.default);
			...
			appendNode(text_40, div_13);

			for (var i_3 = 0; i_3 < each_2_blocks.length; i_3 += 1) {
				each_2_blocks[i_3].m(div_13, null);
			}

			appendNode(text_42, help_1._slotted.default);
		...
		p: function update(changed, state) {
			...
			if ((changed.published) && button_class_value !== (button_class_value = "btn-publish btn btn-primary btn-large " + (state.published?'':'btn-first-publish') + " svelte-1ee9woc")) {
			...
			if ((changed.copy_success) && div_12_class_value !== (div_12_class_value = "copy-success " + (state.copy_success ? 'show':'') + " svelte-1ee9woc")) {
...
function create_if_block_2$1(component, state) {
	...
	return {
		...
		h: function hydrate() {
			i.className = i_class_value = "fa fa-fw fa-refresh " + (state.publishing ? 'fa-spin' : '') + " svelte-1ee9woc";
			span_1.className = "title svelte-1ee9woc";
		...
		p: function update(changed, state) {
			if ((changed.publishing) && i_class_value !== (i_class_value = "fa fa-fw fa-refresh " + (state.publishing ? 'fa-spin' : '') + " svelte-1ee9woc")) {
...
function create_if_block_3(component, state) {
	...
	return {
		...
		h: function hydrate() {
			i.className = i_class_value = "fa fa-fw " + (state.publishing ? 'fa-refresh fa-spin' : 'fa-cloud-upload') + " svelte-1ee9woc";
			span_1.className = "title svelte-1ee9woc";
		...
		p: function update(changed, state) {
			if ((changed.publishing) && i_class_value !== (i_class_value = "fa fa-fw " + (state.publishing ? 'fa-refresh fa-spin' : 'fa-cloud-upload') + " svelte-1ee9woc")) {
				i.className = i_class_value;
			}
		},
...
function create_if_block_4(component, state) {
	...
	return {
		...
		h: function hydrate() {
			div_1.className = "arrow svelte-1ee9woc";
			div_2.className = "text svelte-1ee9woc";
			div.className = "publish-intro svelte-1ee9woc";
		},
...
function create_if_block_8(component, state) {
	...
	return {
		...
		h: function hydrate() {
			div_2.className = div_2_class_value = "bar " + (state.progress < 1 ? '' : 'bar-success') + " svelte-1ee9woc";
			div_1.className = "progress progress-striped active svelte-1ee9woc";
			div.className = div_class_value = "alert " + (state.progress < 1 ? 'alert-info' : 'alert-success') + " publishing" + " svelte-1ee9woc";
		},
		...
		p: function update(changed, state) {
			if ((changed.progress) && div_2_class_value !== (div_2_class_value = "bar " + (state.progress < 1 ? '' : 'bar-success') + " svelte-1ee9woc")) {
				div_2.className = div_2_class_value;
			}

			if ((changed.progress) && div_class_value !== (div_class_value = "alert " + (state.progress < 1 ? 'alert-info' : 'alert-success') + " publishing" + " svelte-1ee9woc")) {
				div.className = div_class_value;
			}
		},
