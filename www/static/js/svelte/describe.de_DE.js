...
function create_main_fragment$1(component, state) {
	var div, h3, text, text_1_value = state.column.name(), text_1, text_2, text_3, p, text_4_value = "Die Werte in den Spalten können nach einer Formel berechnet werden, wie in Excel.", text_4, text_5, label, text_6_value = "computed columns / modal / name", text_6, text_7, input, input_updating = false, text_8, label_1, text_9_value = "Formel (JavaScript)", text_9, text_10, textarea, text_11, p_1, text_12_value = "Verfügbare Spalten", text_12, text_13, text_14, ul, text_15, hr, text_16, button;
