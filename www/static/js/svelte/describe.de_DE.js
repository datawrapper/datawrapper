...
// (20:8) {{#if column && column.type() == 'number'}}
...
function create_main_fragment$5(component, state) {
	var div, div_1, div_2, div_3, text_2, div_4, div_5, raw_value = "Auf Tabellenkopf klicken um<br>Spalteneigenschaften zu ändern", raw_after, text_3, img, text_5, div_6, div_7, div_8, button, raw_1_value = "Ansicht sortieren nach", raw_1_after, text_6, span, text_8, ul, li, a, raw_2_value = "Keine Sortierung", li_class_value, text_11, div_9, i, text_12, div_10, input, input_updating = false, input_placeholder_value, input_class_value, text_13, div_10_class_value, text_15, text_18, handsontable_updating = {}, text_19, div_11, button_1, img_1, text_20, text_21_value = "Zeilen und Spalten vertauschen (transponieren)", text_21, text_22, button_2, i_1, text_23, text_24_value = "Spalte hinzufügen", text_24, text_25, text_26, button_3, i_2, text_27, text_28_value = "Änderungen zurücksetzen", text_28, text_29, button_3_class_value;
	...
	var if_block_2 = (state.searchResults.length > 0) && create_if_block_4(component, state);

	var if_block_3 = (state.search) && create_if_block_5(component, state);
	...
	component.root._beforecreate.push(function() {
		handsontable._bind({ data: 1, transpose: 1, firstRowIsHeader: 1, activeColumn: 1, sorting: 1, search: 1, searchResults: 1, searchIndex: 1 }, handsontable.get());
	});
	...
	return {
		...
		h: function hydrate() {
			...
			div_5.className = "help svelte-1kvuoqm";
			...
			div_7.className = "sort-box svelte-1kvuoqm";
			i.className = "im im-magnifier svelte-1kvuoqm";
			addListener(input, "input", input_input_handler);
			input.type = "text";
			...
			div_9.className = "search-box form-search svelte-1kvuoqm";
			...
			div_11.className = "buttons below-table pull-right svelte-1kvuoqm";
			div_4.className = "span8 svelte-1kvuoqm";
			div_1.className = "row";
		...
		m: function mount(target, anchor) {
			...
			appendNode(text_8, div_8);
			appendNode(ul, div_8);
			appendNode(li, ul);
			appendNode(a, li);
			a.innerHTML = raw_2_value;
			...
			appendNode(text_13, div_10);
			if (if_block_2) if_block_2.m(div_10, null);
			appendNode(text_15, div_9);
			if (if_block_3) if_block_3.m(div_9, null);
...
// (83:24) {{#if searchResults.length > 0}}
...
// (95:24) {{#if searchResults.length > 0}}
...
function create_if_block_5(component, state) {
	...
	function select_block_type_1(state) {
		if (state.searchResults.length > 0) return create_if_block_6;
		if (state.search) return create_if_block_7;
		return null;
	}
