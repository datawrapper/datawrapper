(function (global, factory) {
	...
	*/
	...
	function create_main_fragment$1(component, ctx) {
		var div, text0, h3, text1, text2, p0, text3_value = __('computed columns / modal / intro'), text3, text4, label0, text5_value = __('computed columns / modal / name'), text5, text6, input, input_updating = false, text7, label1, text8_value = __('computed columns / modal / formula'), text8, text9, text10, span, raw_value = __('cc / formula / help'), text11, textarea, text12, text13, text14, text15, p1, text16_value = __('computed columns / modal / available columns'), text16, text17, text18, ul, text19, button, i, text20, text21_value = __('computed columns / modal / remove'), text21;
		...
		return {
			c: function create() {
				...
				addLoc(textarea, file$1, 40, 4, 1278);
				setStyle(p1, "margin-top", "1em");
				addLoc(p1, file$1, 71, 4, 2123);
				ul.className = "col-select svelte-1cx0ai0";
				addLoc(ul, file$1, 75, 4, 2228);
				setStyle(div, "margin-bottom", "15px");
				addLoc(div, file$1, 0, 0, 0);
				i.className = "fa fa-trash";
				addLoc(i, file$1, 83, 4, 2433);
				addListener(button, "click", click_handler_1);
				button.className = "btn btn-danger";
				addLoc(button, file$1, 82, 0, 2371);
			},
	...
	function create_if_block_1(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(i, file$1, 52, 8, 1570);
				p.className = "mini-help formula-hint svelte-1cx0ai0";
				addLoc(p, file$1, 51, 4, 1527);
			},
	...
	const file$2 = "home/david/Projects/core/libs/controls/v2/CheckboxControl.html";
	...
	function create_main_fragment$2(component, ctx) {
		...
		var if_block1 = (ctx.disabled && ctx.disabledMessage) && create_if_block$2(component, ctx);
	...
	function create_if_block$2(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(div0, file$2, 12, 8, 476);
				addLoc(div1, file$2, 11, 4, 445);
			},
	...
	const file$4 = "home/david/Projects/core/libs/controls/v2/SelectInput.html";
	...
	function create_each_block$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(optgroup, file$4, 4, 4, 344);
			},
	...
	function create_main_fragment$6(component, ctx) {
		...
		var checkboxcontrol_initial_data = { label: __('Hide column from visualization') };
	...
	function create_if_block$5(component, ctx) {
		var selectcontrol0_updating = {}, text0, selectcontrol1_updating = {}, text1, div1, label, text2_value = __("Prepend/Append"), text2, text3, div0, input0, input0_updating = false, text4, input1, input1_updating = false;
		...
		return {
			c: function create() {
				...
				addLoc(label, file$5, 36, 12, 1007);
				...
				addLoc(input0, file$5, 40, 16, 1160);
	...
	function create_else_block(component, ctx) {
		var h3, text0_value = __(`Make sure the data looks right`), text0, text1, p, raw_value = __(`describe / data-looks-right`), text2, checkboxcontrol_updating = {}, text3, if_block_anchor;

		var checkboxcontrol_initial_data = { label: __("First row as label") };
	...
	function create_if_block_2$2(component, ctx) {
		...
		var if_block1 = (ctx.activeColumn.type() == 'number') && create_if_block_3$2(component, ctx);
	...
	function create_if_block_8(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(h4, file$8, 59, 16, 2382);
				addLoc(p, file$8, 61, 16, 2447);
				addListener(select, "change", select_change_handler);
				if (!('locale' in ctx)) component.root._beforecreate.push(select_change_handler);
				addLoc(select, file$8, 63, 16, 2517);
			},
	...
	function create_each_block_1$2(component, ctx) {
		...
		return {
			c: function create() {
				...
				option.value = option.__value;
				addLoc(option, file$8, 65, 20, 2612);
			},
