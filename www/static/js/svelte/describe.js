...
function create_main_fragment$4(component, state) {
	...
	var if_block = (state.options.length) && create_if_block$2(component, state);

	var if_block_1 = (state.optgroups.length) && create_if_block_1$1(component, state);
...
function create_main_fragment$5(component, state) {
	...
	var if_block = (state.highlight) && create_if_block$3(component, state);
	...
	var if_block_1 = (state.NAs>0) && create_if_block_1$2(component, state);
...
assign(Handsontable_1.prototype, methods$4);
...
function create_main_fragment(component, state) {
	...
	function select_block_type_1(state) {
		if (state.activeColumn) return create_if_block;
	...
	for (var i_5 = 0; i_5 < each_value_1.length; i_5 += 1) {
		each_blocks[i_5] = create_each_block_1(component, assign(assign({}, state), {
			each_value_1: each_value_1,
			...
			if (changed.columns || changed.sortBy) {
				for (var i_5 = 0; i_5 < each_value_1.length; i_5 += 1) {
					...
					if (each_blocks[i_5]) {
						...
						each_blocks[i_5] = create_each_block_1(component, each_context);
						each_blocks[i_5].c();
						each_blocks[i_5].m(ul, null);
					}
				}
...
function create_if_block(component, state) {
	...
	function select_block_type(state) {
		if (state.customColumn) return create_if_block_1;
