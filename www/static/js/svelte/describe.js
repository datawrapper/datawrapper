	...
	function getCellRenderer (app, chart, dataset, Handsontable) {
	  ...
	  return function (instance, td, row, col, prop, value, cellProperties) {
	    ...
	    if (row > 0) {
	      ...
	      value = column.val(row - 1) === null || column.val(row - 1) === '' ? '–' : formatter(column.val(row - 1), true);
	    }
	    ...
	    if (row > 0 && !column.type(true).isValid(column.val(row - 1)) && column.val(row - 1) !== null && column.val(row - 1) !== '') {
