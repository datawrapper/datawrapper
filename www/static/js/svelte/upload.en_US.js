...
function create_main_fragment$2(component, state) {
	var div, text, div_1, div_2, div_3, h3, text_2, ul, text_3, h4, text_4_value = state.active.title, text_4, text_5, switch_instance_updating = {}, text_8, div_4, switch_instance_1_updating = {}, text_9, div_5, a, text_10_value = "Proceed", text_10, text_11, i, div_1_style_value;
	...
	return {
		...
		p: function update(changed, state) {
			...
			if ((changed.active) && text_4_value !== (text_4_value = state.active.title)) {
...
function create_each_block$1(component, state) {
	...
	return {
		...
		h: function hydrate() {
			...
			li.className = li_class_value = "action " + (state.active==btn?'active':'') + " svelte-10goob";
		...
		p: function update(changed, state) {
			...
			if ((changed.active || changed.buttons) && li_class_value !== (li_class_value = "action " + (state.active==btn?'active':'') + " svelte-10goob")) {
