(function (global, factory) {
	...
	/* controls/visualize/ChartDescription.html generated by Svelte v1.64.0 */



	function create_main_fragment$12(component, state) {
		var div, div_1, label, text_value = __('Title'), text, text_1, input, text_2, label_1, text_3_value = __('Description'), text_3, text_4, textarea, text_5, label_2, text_6_value = __('Notes'), text_6, text_7, input_1, text_9, div_2, div_3, label_3, text_10_value = __('Source name'), text_10, text_11, input_2, input_2_placeholder_value, text_13, div_4, label_4, text_14_value = __('Source URL'), text_14, text_15, input_3, input_3_placeholder_value, text_18, div_5, label_5, text_19_value = __('visualize / annotate / byline'), text_19, text_20, input_4, input_4_placeholder_value;
		...
		return {
			...
			h: function hydrate() {
				...
				input.id = "text-title";
				input.className = "input-xlarge span4";
				input.autocomplete = "off";
				setAttribute(input, "type", "text");
				label_1.className = "control-label";
				label_1.htmlFor = "text-intro";
				...
				label_2.htmlFor = "text-notes";
				input_1.id = "text-notes";
				input_1.className = "input-xlarge span4";
				setAttribute(input_1, "type", "text");
				div_1.className = "pull-left";
				label_3.className = "control-label";
				input_2.id = "describe-source-name";
				input_2.className = "span2";
				input_2.placeholder = input_2_placeholder_value = __('name of the organisation');
				setAttribute(input_2, "type", "text");
				div_3.className = "span2";
				label_4.className = "control-label";
				input_3.id = "describe-source-url";
				input_3.className = "span2";
				input_3.placeholder = input_3_placeholder_value = __('URL of the dataset');
				setAttribute(input_3, "type", "text");
				div_4.className = "span2";
				div_2.className = "row";
				label_5.className = "control-label";
				input_4.id = "describe-byline";
				input_4.className = "input-xlarge span4";
				input_4.placeholder = input_4_placeholder_value = __('visualize / annotate / byline / placeholder');
				setAttribute(input_4, "type", "text");
				div_5.className = "chart-byline";
				div.className = "story-title control-group";
			},
			...
			m: function mount(target, anchor) {
				...
				appendNode(text_14, label_4);
				appendNode(text_15, div_4);
				appendNode(input_3, div_4);
				appendNode(text_18, div);
				appendNode(div_5, div);
				appendNode(label_5, div_5);
				appendNode(text_19, label_5);
				appendNode(text_20, div_5);
				appendNode(input_4, div_5);
			},
