...
function create_main_fragment$9(component, state) {
	...
	return {
		...
		h: function hydrate() {
			span.className = "svelte-ea4yie";
			div_1.className = "content svelte-ea4yie";
			div.className = "help svelte-ea4yie";
		},
...
function oncreate$2() {
    this.set({
        hasHelp: this.options ? !!this.options.slots.help : false
    });
}
...
function SelectAxisColumn(options) {
	...
	if (!options || (!options.target && !options.root)) throw new Error("'target' is a required option");
	init(this, options);
	this._state = assign(assign(this.store._init(["visMeta","dataset"]), data$11()), options.data);
...
function create_main_fragment$15(component, state) {
	...
	var if_block = (!state.notoggle) && create_if_block$10(component, state);
