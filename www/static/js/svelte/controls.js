...
function create_main_fragment$12(component, state) {
	...
	var if_block = (state.hasHelp) && create_if_block$10(component, state);
...
function create_main_fragment$14(component, state) {
	...
	var if_block = (state.$visualization && state.$visualization.axes[state.axis].optional) && create_if_block$11(component, state);
...
function SelectAxisColumn(options) {
	...
	if (!options || (!options.target && !options.root)) { throw new Error("'target' is a required option"); }
	init(this, options);
	this._state = assign(assign(this.store._init(["visualization","dataset"]), data$11()), options.data);
...
function create_main_fragment$15(component, state) {
	...
	var if_block = (state.disabled && state.disabled_msg) && create_if_block$12(component, state);
...
function create_main_fragment$16(component, state) {
	...
	var if_block = (state.icon) && create_if_block$13(component, state);
...
function create_main_fragment$17(component, state) {
	...
	var if_block = (state.id==state.active) && create_if_block$14(component, state);
...
function create_main_fragment$18(component, state) {
	...
	var if_block = (!state.notoggle) && create_if_block$15(component, state);
...
function create_main_fragment$19(component, state) {
	...
	var if_block = (state.passed) && create_if_block$16(component, state);
...
function EditorNavStep(options) {
	...
	if (!options || (!options.target && !options.root)) { throw new Error("'target' is a required option"); }
	init(this, options);
	this._state = assign(assign(this.store._init(["lastEditStep"]), data$15()), options.data);
...
function create_main_fragment$20(component, state) {
	...
	var if_block = (state.$user.id != state.$authorId && state.$user.isAdmin) && create_if_block$17(component, state);
...
function EditorNav(options) {
	...
	if (!options || (!options.target && !options.root)) { throw new Error("'target' is a required option"); }
	init(this, options);
	this._state = assign(assign(this.store._init(["user","authorId"]), data$16()), options.data);
