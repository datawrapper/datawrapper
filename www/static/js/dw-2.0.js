...
dw.column.types.date = (function() {
    ...
    _.each(MONTHS, function(abbr, m) {
        _.each(abbr, function(a) { MMM_key[a] = m; });
    });
...
dw.visualization = (function() {
    ...
    var visualization = function(id) {
        if (!__vis[id]) {
            ...
            if (known.length > 0)
                console.warn("try one of these instead: " + known.join(", "));
            return false;
        }
        return new __vis[id]();
    };
    ...
    visualization.register = function(id) {
        var parent =
            arguments.length === 3
                ? __vis[arguments[1]].prototype
                : dw.visualization.base;
