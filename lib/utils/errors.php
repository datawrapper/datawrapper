...
function error_chart_not_published() {
    error_page('create',
        'Hold on!',
        'Sorry, but it seems that the chart you want to see is not quite ready for the world, yet. Why don\'t you just relax and wait a minute?'
    );
}

function error_not_allowed_to_publish() {
    error_page('create',
        'Whoops! You’re not allowed to publish charts, yet',
        'Sorry, but it seems that your account is not ready to publish charts, yet. If you created the chart as a guest, you should <a href="#login">sign up for a free account</a> now. In case you already did that, you probably still need to activate you e-mail address by clicking on that activation link we sent you.'
    );
}
