...
function publish_get_embed_templates() {
    ...
    $templates[] = [
        ...
        "template" => '<iframe src="%chart_url%" scrolling="no" frameborder="0" allowtransparency="true" width="%chart_width%" height="%chart_height%"></iframe>',
    ];
