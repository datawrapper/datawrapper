...
function publish_get_embed_templates() {
    ...
    $templates[] = [
        ...
        "template" => '<iframe title="%chart_title%" aria-describedby="%chart_intro%" id="datawrapper-chart-%chart_id%" src="%chart_url%" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important;" height="%chart_height%"></iframe><script type="text/javascript">'
    ...
    $templates[] = [
        ...
        "template" => '<iframe title="%chart_title%" aria-describedby="%chart_intro%" src="%chart_url%" scrolling="no" frameborder="0" width="%chart_width%" height="%chart_height%"></iframe>',
    ];
