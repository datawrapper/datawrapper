...
/**
 * This class defines the structure of the 'organisation_product' table.
 *
 *
 *
 ...
 */
class OrganisationProductTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'datawrapper.map.OrganisationProductTableMap';
    ...
    {
        // attributes
        $this->setName('organisation_product');
        $this->setPhpName('OrganisationProduct');
        $this->setClassname('OrganisationProduct');
