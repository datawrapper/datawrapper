...
/**
 * Base class that represents a row from the 'organisation_product' table.
 *
 *
 *
 * @package    propel.generator.datawrapper.om
 */
abstract class BaseOrganisationProduct extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'OrganisationProductPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        OrganisationProductPeer
     */
     ...
     * @return OrganisationProduct The current object (for fluent API support)
     */
    public function setOrganizationId($v)
    {
        ...
        if ($this->organization_id !== $v) {
            ...
            $this->modifiedColumns[] = OrganisationProductPeer::ORGANIZATION_ID;
        }
    ...
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[] = OrganisationProductPeer::PRODUCT_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = OrganisationProductPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating OrganisationProduct object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = OrganisationProductPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = OrganisationProductQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OrganisationProductPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(OrganisationProductPeer::ORGANIZATION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`organization_id`';
        }
        if ($this->isColumnModified(OrganisationProductPeer::PRODUCT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`product_id`';
        }

        $sql = sprintf(
            'INSERT INTO `organisation_product` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = OrganisationProductPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = OrganisationProductPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['OrganisationProduct'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OrganisationProduct'][serialize($this->getPrimaryKey())] = true;
        $keys = OrganisationProductPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OrganisationProductPeer::ORGANIZATION_ID)) $criteria->add(OrganisationProductPeer::ORGANIZATION_ID, $this->organization_id);
        if ($this->isColumnModified(OrganisationProductPeer::PRODUCT_ID)) $criteria->add(OrganisationProductPeer::PRODUCT_ID, $this->product_id);
    ...
    {
        $criteria = new Criteria(OrganisationProductPeer::DATABASE_NAME);
        $criteria->add(OrganisationProductPeer::ORGANIZATION_ID, $this->organization_id);
        $criteria->add(OrganisationProductPeer::PRODUCT_ID, $this->product_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of OrganisationProduct (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return OrganisationProduct Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return OrganisationProductPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new OrganisationProductPeer();
        }
    ...
    public function getOrganization(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aOrganization === null && (($this->organization_id !== "" && $this->organization_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aOrganization->addOrganisationProducts($this);
             */
        }
    ...
    public function getProduct(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProduct === null && (($this->product_id !== "" && $this->product_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProduct->addOrganisationProducts($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(OrganisationProductPeer::DEFAULT_STRING_FORMAT);
    }
