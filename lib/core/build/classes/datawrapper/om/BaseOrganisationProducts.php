...
/**
 * Base class that represents a row from the 'organisation_products' table.
 *
 *
 *
 * @package    propel.generator.datawrapper.om
 */
abstract class BaseOrganisationProducts extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'OrganisationProductsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        OrganisationProductsPeer
     */
     ...
     * @return OrganisationProducts The current object (for fluent API support)
     */
    public function setOrganizationId($v)
    {
        ...
        if ($this->organization_id !== $v) {
            ...
            $this->modifiedColumns[] = OrganisationProductsPeer::ORGANIZATION_ID;
        }
    ...
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[] = OrganisationProductsPeer::PRODUCT_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = OrganisationProductsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating OrganisationProducts object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = OrganisationProductsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = OrganisationProductsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OrganisationProductsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(OrganisationProductsPeer::ORGANIZATION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`organization_id`';
        }
        if ($this->isColumnModified(OrganisationProductsPeer::PRODUCT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`product_id`';
        }

        $sql = sprintf(
            'INSERT INTO `organisation_products` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = OrganisationProductsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = OrganisationProductsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['OrganisationProducts'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OrganisationProducts'][serialize($this->getPrimaryKey())] = true;
        $keys = OrganisationProductsPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OrganisationProductsPeer::ORGANIZATION_ID)) $criteria->add(OrganisationProductsPeer::ORGANIZATION_ID, $this->organization_id);
        if ($this->isColumnModified(OrganisationProductsPeer::PRODUCT_ID)) $criteria->add(OrganisationProductsPeer::PRODUCT_ID, $this->product_id);
    ...
    {
        $criteria = new Criteria(OrganisationProductsPeer::DATABASE_NAME);
        $criteria->add(OrganisationProductsPeer::ORGANIZATION_ID, $this->organization_id);
        $criteria->add(OrganisationProductsPeer::PRODUCT_ID, $this->product_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getOrganizationId()) && (null === $this->getProductId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of OrganisationProducts (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return OrganisationProducts Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return OrganisationProductsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new OrganisationProductsPeer();
        }
    ...
    public function setOrganization(Organization $v = null)
    {
        ...
        if ($v !== null) {
            $v->addOrganisationProducts($this);
        }
    ...
    public function getOrganization(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aOrganization === null && (($this->organization_id !== "" && $this->organization_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aOrganization->addOrganisationProductss($this);
             */
        }
    ...
    public function getProduct(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProduct === null && (($this->product_id !== "" && $this->product_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProduct->addOrganisationProductss($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(OrganisationProductsPeer::DEFAULT_STRING_FORMAT);
    }
