...
/**
 * Base class that represents a row from the 'product_plugins' table.
 *
 *
 *
 * @package    propel.generator.datawrapper.om
 */
abstract class BaseProductPlugins extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProductPluginsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProductPluginsPeer
     */
     ...
     * @return ProductPlugins The current object (for fluent API support)
     */
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[] = ProductPluginsPeer::PRODUCT_ID;
        }
    ...
    public function setPluginId($v)
    {
        ...
        if ($this->plugin_id !== $v) {
            $this->plugin_id = $v;
            $this->modifiedColumns[] = ProductPluginsPeer::PLUGIN_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->product_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            ...
            return $startcol + 2; // 2 = ProductPluginsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProductPlugins object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProductPluginsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProductPluginsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProductPluginsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProductPluginsPeer::PRODUCT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`product_id`';
        }
        if ($this->isColumnModified(ProductPluginsPeer::PLUGIN_ID)) {
            $modifiedColumns[':p' . $index++]  = '`plugin_id`';
        }

        $sql = sprintf(
            'INSERT INTO `product_plugins` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProductPluginsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProductPluginsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProductPlugins'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProductPlugins'][serialize($this->getPrimaryKey())] = true;
        $keys = ProductPluginsPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductPluginsPeer::PRODUCT_ID)) $criteria->add(ProductPluginsPeer::PRODUCT_ID, $this->product_id);
        if ($this->isColumnModified(ProductPluginsPeer::PLUGIN_ID)) $criteria->add(ProductPluginsPeer::PLUGIN_ID, $this->plugin_id);
    ...
    {
        $criteria = new Criteria(ProductPluginsPeer::DATABASE_NAME);
        $criteria->add(ProductPluginsPeer::PRODUCT_ID, $this->product_id);
        $criteria->add(ProductPluginsPeer::PLUGIN_ID, $this->plugin_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProductPlugins (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProductPlugins Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProductPluginsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProductPluginsPeer();
        }
    ...
    public function getProduct(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProduct === null && (($this->product_id !== "" && $this->product_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProduct->addProductPluginss($this);
             */
        }
    ...
    public function getPlugin(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPlugin === null && (($this->plugin_id !== "" && $this->plugin_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPlugin->addProductPluginss($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ProductPluginsPeer::DEFAULT_STRING_FORMAT);
    }
