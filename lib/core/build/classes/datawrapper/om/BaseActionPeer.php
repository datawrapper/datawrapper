...
abstract class BaseActionPeer {
	...
	/** the column name for the ACTION_TIME field */
	const ACTION_TIME = 'action.ACTION_TIME';
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::ACTION_TIME, self::KEY, self::DETAILS, ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::ACTION_TIME => 2, self::KEY => 3, self::DETAILS => 4, ),
	 ...
	 *
	 * @param      Action $value A Action object.
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ActionPeer::USER_ID, UserPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Action objects pre-filled with their User objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Action) to $obj2 (User)
				$obj2->addAction($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Action) to the collection in $obj2 (User)
				$obj2->addAction($obj1);
