...
/**
 * Base class that represents a row from the 'user_product' table.
 *
 *
 *
 * @package    propel.generator.datawrapper.om
 */
abstract class BaseUserProduct extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'UserProductPeer';
    ...
    /**
     * Initializes internal state of BaseUserProduct object.
     * @see        applyDefaults()
     */
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = UserProductPeer::USER_ID;
        }
    ...
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[] = UserProductPeer::PRODUCT_ID;
        }
    ...
    public function setCreatedByAdmin($v)
    {
        ...
        if ($this->created_by_admin !== $v) {
            ...
            $this->modifiedColumns[] = UserProductPeer::CREATED_BY_ADMIN;
        }
    ...
    public function setChanges($v)
    {
        ...
        if ($this->changes !== $v) {
            $this->changes = $v;
            $this->modifiedColumns[] = UserProductPeer::CHANGES;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = UserProductPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = UserProductPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UserProductQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UserProductPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserProductPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(UserProductPeer::PRODUCT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`product_id`';
        }
        if ($this->isColumnModified(UserProductPeer::CREATED_BY_ADMIN)) {
            $modifiedColumns[':p' . $index++]  = '`created_by_admin`';
        }
        if ($this->isColumnModified(UserProductPeer::CHANGES)) {
    ...
    {
        $pos = UserProductPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserProductPeer::CREATED_BY_ADMIN)) $criteria->add(UserProductPeer::CREATED_BY_ADMIN, $this->created_by_admin);
        if ($this->isColumnModified(UserProductPeer::CHANGES)) $criteria->add(UserProductPeer::CHANGES, $this->changes);
    ...
    {
        $criteria = new Criteria(UserProductPeer::DATABASE_NAME);
        $criteria->add(UserProductPeer::USER_ID, $this->user_id);
        $criteria->add(UserProductPeer::PRODUCT_ID, $this->product_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of UserProduct (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return UserProduct Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return UserProductPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new UserProductPeer();
        }
    ...
    public function getUser(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUser === null && ($this->user_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addUserProducts($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(UserProductPeer::DEFAULT_STRING_FORMAT);
    }
