...
/**
 * Base class that represents a row from the 'plugin_organization' table.
 *
 *
 *
 * @package    propel.generator.datawrapper.om
 */
abstract class BasePluginOrganization extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PluginOrganizationPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PluginOrganizationPeer
     */
     ...
     * @return PluginOrganization The current object (for fluent API support)
     */
    public function setPluginId($v)
    {
        ...
        if ($this->plugin_id !== $v) {
            $this->plugin_id = $v;
            $this->modifiedColumns[] = PluginOrganizationPeer::PLUGIN_ID;
        }
    ...
    public function setOrganizationId($v)
    {
        ...
        if ($this->organization_id !== $v) {
            ...
            $this->modifiedColumns[] = PluginOrganizationPeer::ORGANIZATION_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->plugin_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            ...
            return $startcol + 2; // 2 = PluginOrganizationPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PluginOrganization object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PluginOrganizationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PluginOrganizationQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PluginOrganizationPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PluginOrganizationPeer::PLUGIN_ID)) {
            $modifiedColumns[':p' . $index++]  = '`plugin_id`';
        }
        if ($this->isColumnModified(PluginOrganizationPeer::ORGANIZATION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`organization_id`';
        }

        $sql = sprintf(
            'INSERT INTO `plugin_organization` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PluginOrganizationPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PluginOrganizationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PluginOrganization'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PluginOrganization'][serialize($this->getPrimaryKey())] = true;
        $keys = PluginOrganizationPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PluginOrganizationPeer::PLUGIN_ID)) $criteria->add(PluginOrganizationPeer::PLUGIN_ID, $this->plugin_id);
        if ($this->isColumnModified(PluginOrganizationPeer::ORGANIZATION_ID)) $criteria->add(PluginOrganizationPeer::ORGANIZATION_ID, $this->organization_id);
    ...
    {
        $criteria = new Criteria(PluginOrganizationPeer::DATABASE_NAME);
        $criteria->add(PluginOrganizationPeer::PLUGIN_ID, $this->plugin_id);
        $criteria->add(PluginOrganizationPeer::ORGANIZATION_ID, $this->organization_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getPluginId()) && (null === $this->getOrganizationId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of PluginOrganization (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PluginOrganization Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PluginOrganizationPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PluginOrganizationPeer();
        }
    ...
    public function getPlugin(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPlugin === null && (($this->plugin_id !== "" && $this->plugin_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPlugin->addPluginOrganizations($this);
             */
        }
    ...
    public function getOrganization(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aOrganization === null && (($this->organization_id !== "" && $this->organization_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOrganization->addPluginOrganizations($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PluginOrganizationPeer::DEFAULT_STRING_FORMAT);
    }
