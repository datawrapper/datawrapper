...
/**
 * Base class that represents a row from the 'user_data' table.
 *
 *
 *
...
abstract class BaseUserData extends BaseObject implements Persistent
{
    ...
    /**
     * Initializes internal state of BaseUserData object.
     * @see        applyDefaults()
     */
     ...
     * @return UserData The current object (for fluent API support)
     */
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = UserDataPeer::USER_ID;
        }
    ...
    public function setStoredAt($v)
    {
        ...
        if ($this->stored_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = UserDataPeer::STORED_AT;
            }
    ...
    public function setKey($v)
    {
        ...
        if ($this->key !== $v) {
            $this->key = $v;
            $this->modifiedColumns[] = UserDataPeer::KEY;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[] = UserDataPeer::VALUE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = UserDataPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = UserDataPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UserDataQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UserDataPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserDataPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(UserDataPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(UserDataPeer::STORED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`stored_at`';
        }
        if ($this->isColumnModified(UserDataPeer::KEY)) {
            $modifiedColumns[':p' . $index++]  = '`key`';
        }
        if ($this->isColumnModified(UserDataPeer::VALUE)) {
            $modifiedColumns[':p' . $index++]  = '`value`';
        }

        $sql = sprintf(
            'INSERT INTO `user_data` (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['UserData'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UserData'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserDataPeer::USER_ID)) $criteria->add(UserDataPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(UserDataPeer::STORED_AT)) $criteria->add(UserDataPeer::STORED_AT, $this->stored_at);
        if ($this->isColumnModified(UserDataPeer::KEY)) $criteria->add(UserDataPeer::KEY, $this->key);
        if ($this->isColumnModified(UserDataPeer::VALUE)) $criteria->add(UserDataPeer::VALUE, $this->value);
    ...
    {
        return (string) $this->exportTo(UserDataPeer::DEFAULT_STRING_FORMAT);
    }
