...
/**
 * Base class that represents a row from the 'auth_token' table.
 *
 *
 *
 * @package    propel.generator.datawrapper.om
 */
abstract class BaseAuthToken extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'AuthTokenPeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = AuthTokenPeer::ID;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = AuthTokenPeer::USER_ID;
        }
    ...
    public function setToken($v)
    {
        ...
        if ($this->token !== $v) {
            $this->token = $v;
            $this->modifiedColumns[] = AuthTokenPeer::TOKEN;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AuthTokenPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AuthTokenQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AuthTokenPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AuthTokenPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(AuthTokenPeer::USER_ID)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AuthTokenPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AuthTokenPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['AuthToken'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AuthToken'][serialize($this->getPrimaryKey())] = true;
        $keys = AuthTokenPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(AuthTokenPeer::DATABASE_NAME);
        $criteria->add(AuthTokenPeer::ID, $this->id);
        $criteria->add(AuthTokenPeer::USER_ID, $this->user_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of AuthToken (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return AuthToken Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return AuthTokenPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new AuthTokenPeer();
        }
    ...
    {
        return (string) $this->exportTo(AuthTokenPeer::DEFAULT_STRING_FORMAT);
    }
