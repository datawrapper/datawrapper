...
/**
 * Base class that represents a row from the 'organization_invite' table.
 *
 *
 *
 * @package    propel.generator.datawrapper.om
 */
abstract class BaseOrganizationInvite extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'OrganizationInvitePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        OrganizationInvitePeer
     */
     ...
     * @return OrganizationInvite The current object (for fluent API support)
     */
    public function setInviteToken($v)
    {
        ...
        if ($this->invite_token !== $v) {
            $this->invite_token = $v;
            $this->modifiedColumns[] = OrganizationInvitePeer::INVITE_TOKEN;
        }
    ...
    public function setOrganizationId($v)
    {
        ...
        if ($this->organization_id !== $v) {
            ...
            $this->modifiedColumns[] = OrganizationInvitePeer::ORGANIZATION_ID;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = OrganizationInvitePeer::USER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->invite_token = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            ...
            return $startcol + 3; // 3 = OrganizationInvitePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating OrganizationInvite object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = OrganizationInvitePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = OrganizationInviteQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OrganizationInvitePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(OrganizationInvitePeer::INVITE_TOKEN)) {
            $modifiedColumns[':p' . $index++]  = '`invite_token`';
        }
        if ($this->isColumnModified(OrganizationInvitePeer::ORGANIZATION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`organization_id`';
        }
        if ($this->isColumnModified(OrganizationInvitePeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }

        $sql = sprintf(
            'INSERT INTO `organization_invite` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = OrganizationInvitePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = OrganizationInvitePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['OrganizationInvite'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OrganizationInvite'][$this->getPrimaryKey()] = true;
        $keys = OrganizationInvitePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getInviteToken(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setInviteToken($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OrganizationInvitePeer::INVITE_TOKEN)) $criteria->add(OrganizationInvitePeer::INVITE_TOKEN, $this->invite_token);
        if ($this->isColumnModified(OrganizationInvitePeer::ORGANIZATION_ID)) $criteria->add(OrganizationInvitePeer::ORGANIZATION_ID, $this->organization_id);
        if ($this->isColumnModified(OrganizationInvitePeer::USER_ID)) $criteria->add(OrganizationInvitePeer::USER_ID, $this->user_id);
    ...
    {
        $criteria = new Criteria(OrganizationInvitePeer::DATABASE_NAME);
        $criteria->add(OrganizationInvitePeer::INVITE_TOKEN, $this->invite_token);
    ...
    /**
     * Generic method to set the primary key (invite_token column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getInviteToken();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of OrganizationInvite (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setInviteToken(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return OrganizationInvite Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return OrganizationInvitePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new OrganizationInvitePeer();
        }
    ...
    public function getUser(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUser === null && ($this->user_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addOrganizationInvites($this);
             */
        }
    ...
    public function getOrganization(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aOrganization === null && (($this->organization_id !== "" && $this->organization_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOrganization->addOrganizationInvites($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(OrganizationInvitePeer::DEFAULT_STRING_FORMAT);
    }
