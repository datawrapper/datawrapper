...
/**
 * Base class that represents a row from the 'user_organization' table.
 *
 *
 *
 * @package    propel.generator.datawrapper.om
 */
abstract class BaseUserOrganization extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'UserOrganizationPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        UserOrganizationPeer
     */
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = UserOrganizationPeer::USER_ID;
        }
    ...
    public function setOrganizationId($v)
    {
        ...
        if ($this->organization_id !== $v) {
            ...
            $this->modifiedColumns[] = UserOrganizationPeer::ORGANIZATION_ID;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = UserOrganizationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UserOrganizationQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UserOrganizationPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserOrganizationPeer::USER_ID)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = UserOrganizationPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = UserOrganizationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['UserOrganization'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UserOrganization'][serialize($this->getPrimaryKey())] = true;
     ...
     * objects.
     *
     * @param object $copyObj An object of UserOrganization (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return UserOrganization Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return UserOrganizationPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new UserOrganizationPeer();
        }
    ...
    public function getUser(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUser === null && ($this->user_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addUserOrganizations($this);
             */
        }
    ...
    public function getOrganization(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aOrganization === null && (($this->organization_id !== "" && $this->organization_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOrganization->addUserOrganizations($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(UserOrganizationPeer::DEFAULT_STRING_FORMAT);
    }
