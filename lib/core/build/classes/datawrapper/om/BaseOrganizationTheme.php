...
/**
 * Base class that represents a row from the 'organization_theme' table.
 *
 *
 *
 * @package    propel.generator.datawrapper.om
 */
abstract class BaseOrganizationTheme extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'OrganizationThemePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        OrganizationThemePeer
     */
     ...
     * @return OrganizationTheme The current object (for fluent API support)
     */
    public function setOrganizationId($v)
    {
        ...
        if ($this->organization_id !== $v) {
            ...
            $this->modifiedColumns[] = OrganizationThemePeer::ORGANIZATION_ID;
        }
    ...
    public function setThemeId($v)
    {
        ...
        if ($this->theme_id !== $v) {
            $this->theme_id = $v;
            $this->modifiedColumns[] = OrganizationThemePeer::THEME_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->theme_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = OrganizationThemePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating OrganizationTheme object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = OrganizationThemePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = OrganizationThemeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OrganizationThemePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(OrganizationThemePeer::ORGANIZATION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`organization_id`';
        }
        if ($this->isColumnModified(OrganizationThemePeer::THEME_ID)) {
            $modifiedColumns[':p' . $index++]  = '`theme_id`';
        }

        $sql = sprintf(
            'INSERT INTO `organization_theme` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`organization_id`':
                        ...
                        break;
                    case '`theme_id`':
                        $stmt->bindValue($identifier, $this->theme_id, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = OrganizationThemePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = OrganizationThemePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['OrganizationTheme'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OrganizationTheme'][serialize($this->getPrimaryKey())] = true;
        $keys = OrganizationThemePeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OrganizationThemePeer::ORGANIZATION_ID)) $criteria->add(OrganizationThemePeer::ORGANIZATION_ID, $this->organization_id);
        if ($this->isColumnModified(OrganizationThemePeer::THEME_ID)) $criteria->add(OrganizationThemePeer::THEME_ID, $this->theme_id);
    ...
    {
        $criteria = new Criteria(OrganizationThemePeer::DATABASE_NAME);
        $criteria->add(OrganizationThemePeer::ORGANIZATION_ID, $this->organization_id);
        $criteria->add(OrganizationThemePeer::THEME_ID, $this->theme_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getOrganizationId()) && (null === $this->getThemeId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of OrganizationTheme (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return OrganizationTheme Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return OrganizationThemePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new OrganizationThemePeer();
        }
    ...
    public function getOrganization(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aOrganization === null && (($this->organization_id !== "" && $this->organization_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aOrganization->addOrganizationThemes($this);
             */
        }
    ...
    {
        if ($this->aTheme === null && (($this->theme_id !== "" && $this->theme_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTheme->addOrganizationThemes($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(OrganizationThemePeer::DEFAULT_STRING_FORMAT);
    }
