...
abstract class BaseStatsPeer
{
     ...
     * e.g. StatsPeer::$fieldNames[StatsPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Time', 'Metric', 'Value', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'time', 'metric', 'value', ),
        BasePeer::TYPE_COLNAME => array (StatsPeer::ID, StatsPeer::TIME, StatsPeer::METRIC, StatsPeer::VALUE, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. StatsPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (StatsPeer::ID => 0, StatsPeer::TIME => 1, StatsPeer::METRIC => 2, StatsPeer::VALUE => 3, ),
    ...
    {
        $toNames = StatsPeer::getFieldNames($toType);
        $key = isset(StatsPeer::$fieldKeys[$fromType][$name]) ? StatsPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(StatsPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, StatsPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return StatsPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(StatsPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(StatsPeer::DATABASE_NAME);
     ...
     *
     * @param      Stats $obj A Stats object.
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(StatsPeer::$instances[$key])) {
                return StatsPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      ...
      {
        foreach (StatsPeer::$instances as $instance)
        {
          $instance->clearAllReferences(true);
        }
      }
        StatsPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(StatsPeer::DATABASE_NAME)->getTable(StatsPeer::TABLE_NAME);
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(StatsPeer::DATABASE_NAME);
