...
/**
 * Base class that represents a row from the 'user_folder' table.
 *
 *
 *
 * @package    propel.generator.datawrapper.om
 */
abstract class BaseUserFolder extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'UserFolderPeer';
     ...
     * @return UserFolder The current object (for fluent API support)
     */
    public function setUfId($v)
    {
        ...
        if ($this->uf_id !== $v) {
            $this->uf_id = $v;
            $this->modifiedColumns[] = UserFolderPeer::UF_ID;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = UserFolderPeer::USER_ID;
        }
    ...
    public function setFolderName($v)
    {
        ...
        if ($this->folder_name !== $v) {
            $this->folder_name = $v;
            $this->modifiedColumns[] = UserFolderPeer::FOLDER_NAME;
        }
    ...
    public function setParentId($v)
    {
        ...
        if ($this->parent_id !== $v) {
            $this->parent_id = $v;
            $this->modifiedColumns[] = UserFolderPeer::PARENT_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = UserFolderPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating UserFolder object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = UserFolderPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UserFolderQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UserFolderPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserFolderPeer::UF_ID)) {
            $modifiedColumns[':p' . $index++]  = '`uf_id`';
        }
        if ($this->isColumnModified(UserFolderPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(UserFolderPeer::FOLDER_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`folder_name`';
        }
        if ($this->isColumnModified(UserFolderPeer::PARENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`parent_id`';
        }

        $sql = sprintf(
            'INSERT INTO `user_folder` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = UserFolderPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = UserFolderPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['UserFolder'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UserFolder'][serialize($this->getPrimaryKey())] = true;
        $keys = UserFolderPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getUfId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserFolderPeer::UF_ID)) $criteria->add(UserFolderPeer::UF_ID, $this->uf_id);
        if ($this->isColumnModified(UserFolderPeer::USER_ID)) $criteria->add(UserFolderPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(UserFolderPeer::FOLDER_NAME)) $criteria->add(UserFolderPeer::FOLDER_NAME, $this->folder_name);
        if ($this->isColumnModified(UserFolderPeer::PARENT_ID)) $criteria->add(UserFolderPeer::PARENT_ID, $this->parent_id);
    ...
    {
        $criteria = new Criteria(UserFolderPeer::DATABASE_NAME);
        $criteria->add(UserFolderPeer::UF_ID, $this->uf_id);
        $criteria->add(UserFolderPeer::PARENT_ID, $this->parent_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of UserFolder (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return UserFolder Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return UserFolderPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new UserFolderPeer();
        }
    ...
    public function getUser(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUser === null && ($this->user_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addUserFolders($this);
             */
        }
     ...
     * If this UserFolder is new, it will return
    ...
    public function setChartFolders(PropelCollection $chartFolders, PropelPDO $con = null)
    {
        ...
        foreach ($chartFoldersToDelete as $chartFolderRemoved) {
            $chartFolderRemoved->setUserFolder(null);
        }
    ...
    protected function doAddChartFolder($chartFolder)
    {
        ...
        $chartFolder->setUserFolder($this);
    }
    ...
    public function removeChartFolder($chartFolder)
    {
        if ($this->getChartFolders()->contains($chartFolder)) {
            ...
            $chartFolder->setUserFolder(null);
        }
     ...
     * Otherwise if this UserFolder is new, it will return
     * an empty collection; or if this UserFolder has previously
     * been saved, it will retrieve related ChartFolders from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in UserFolder.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(UserFolderPeer::DEFAULT_STRING_FORMAT);
    }
