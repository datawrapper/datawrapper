...
abstract class BasePluginDataPeer {
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID, self::PLUGIN_ID, self::STORED_AT, self::KEY, self::DATA, ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PLUGIN_ID => 1, self::STORED_AT => 2, self::KEY => 3, self::DATA => 4, ),
	 ...
	 *
	 * @param      PluginData $value A PluginData object.
