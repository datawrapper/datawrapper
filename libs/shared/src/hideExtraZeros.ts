...
export function forceOptionalDecimals(format: string) {
...
function detectExtraZeros(value: string, format: string) {
...
export function hideExtraZeros(value: string, format: string) {
    if (!format) {
