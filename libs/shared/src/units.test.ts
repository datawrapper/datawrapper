...
import { UNIT_IN, UNIT_MM, UNIT_PX, pxToUnit, unitToPx } from './units';
...
test('unitToPx() throws and error for invalid unit', t => {
    t.throws(() => {
        ...
        unitToPx(12.3, undefined as any);
    });
    t.throws(() => {
        // Violating type constraints to check handling of incorrect data
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        unitToPx(12.3, 'foo' as any);
    });
});
...
test('pxToUnit() throws and error for invalid unit', t => {
    t.throws(() => {
        // Violating type constraints to check handling of incorrect data
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        pxToUnit(12.3, undefined as any);
    });
    t.throws(() => {
        // Violating type constraints to check handling of incorrect data
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        pxToUnit(12.3, 'foo' as any);
    });
});
