...
/**
 * Source: https://github.com/muan/emojilib/blob/main/dist/emoji-en-US.json
 */
const emojiKeywords = {
    '😀': ['grinning_face', 'face', 'smile', 'happy', 'joy', ':D', 'grin', 'smiley'],
    '😃': [
    ...
    '🥶': ['cold_face', 'face', 'blue', 'freezing', 'frozen', 'frostbite', 'icicles', 'ice'],
    '🥴': [
        'woozy_face',
        'face',
        'dizzy',
    ...
    '🥳': ['partying_face', 'face', 'celebration', 'woohoo', 'birthday', 'hat', 'horn', 'party'],
    '😎': [
    ...
    '💛': ['yellow_heart', 'love', 'like', 'affection', 'valentines', 'bf', 'gold', 'snapchat'],
    '💚': ['green_heart', 'love', 'like', 'affection', 'valentines', 'nct'],
    '💙': ['blue_heart', 'love', 'like', 'affection', 'valentines', 'brand', 'neutral'],
    '💜': ['purple_heart', 'love', 'like', 'affection', 'valentines', 'bts', 'emoji'],
    '🤎': ['brown_heart', 'coffee'],
    '🖤': ['black_heart', 'evil', 'dark', 'wicked'],
    '🤍': ['white_heart', 'pure'],
    '💯': [
        'hundred_points',
        'score',
    ...
    '👨‍🦱': ['man_curly_hair', 'hairstyle', 'adult', 'haired', 'male', 'men'],
    '👨‍🦳': ['man_white_hair', 'old', 'elder', 'adult', 'haired', 'male', 'men'],
    '👨‍🦲': ['man_bald', 'hairless', 'adult', 'hair', 'male', 'men', 'no'],
    ...
    '🧑‍🦱': ['person_curly_hair', 'hairstyle', 'adult', 'gender', 'haired', 'unspecified'],
    '👩‍🦳': ['woman_white_hair', 'old', 'elder', 'adult', 'female', 'haired', 'women'],
    '🧑‍🦳': ['person_white_hair', 'elder', 'old', 'adult', 'gender', 'haired', 'unspecified'],
    '👩‍🦲': ['woman_bald', 'hairless', 'adult', 'female', 'hair', 'no', 'women'],
    '🧑‍🦲': ['person_bald', 'hairless', 'adult', 'gender', 'hair', 'no', 'unspecified'],
    '👱‍♀️': ['woman_blond_hair', 'woman', 'female', 'girl', 'blonde', 'person', 'haired', 'women'],
    '👱‍♂️': ['man_blond_hair', 'man', 'male', 'boy', 'blonde', 'guy', 'person', 'haired', 'men'],
    '🧓': [
        'older_person',
        'human',
        'elder',
    ...
    '🙎‍♀️': ['woman_pouting', 'female', 'girl', 'woman', 'gesture', 'women'],
    '🙅': [
        'person_gesturing_no',
        'decline',
        'arms',
    ...
    '🧏‍♀️': ['deaf_woman', 'accessibility', 'female', 'women'],
    '🙇': [
        'person_bowing',
        'respectiful',
        'apology',
    ...
    '👩‍⚖️': ['woman_judge', 'justice', 'court', 'woman', 'human', 'female', 'law', 'scales', 'women'],
    ...
    '👩‍🍳': ['woman_cook', 'chef', 'woman', 'human', 'cooking', 'female', 'food', 'service', 'women'],
    '🧑‍🔧': [
        'mechanic',
        'worker',
        'technician',
    ...
    '🕵️‍♀️': ['woman_detective', 'human', 'spy', 'detective', 'female', 'woman', 'sleuth', 'women'],
    '💂': ['guard', 'protect', 'british', 'foot', 'guardsman'],
    '💂‍♂️': ['man_guard', 'uk', 'gb', 'british', 'male', 'guy', 'royal', 'guardsman', 'men'],
    '💂‍♀️': [
        'woman_guard',
        'uk',
        'gb',
    ...
    '👳‍♀️': ['woman_wearing_turban', 'female', 'indian', 'hinduism', 'arabs', 'woman', 'women'],
    '👲': [
        'man_with_skullcap',
        'male',
        'boy',
    ...
    '🧚‍♀️': ['woman_fairy', 'woman', 'female', 'fantasy', 'titania', 'wings', 'women'],
    '🧛': ['vampire', 'blood', 'twilight', 'dracula', 'fantasy', 'undead'],
    '🧛‍♂️': ['man_vampire', 'man', 'male', 'dracula', 'fantasy', 'men', 'undead'],
    '🧛‍♀️': ['woman_vampire', 'woman', 'female', 'fantasy', 'undead', 'unded', 'women'],
    ...
    '🧝‍♂️': ['man_elf', 'man', 'male', 'ears', 'fantasy', 'magical', 'men', 'pointed'],
    '🧝‍♀️': ['woman_elf', 'woman', 'female', 'ears', 'fantasy', 'magical', 'pointed', 'women'],
    '🧞': ['genie', 'magical', 'wishes', 'djinn', 'djinni', 'fantasy', 'jinni'],
    '🧞‍♂️': ['man_genie', 'man', 'male', 'djinn', 'fantasy', 'men'],
    '🧞‍♀️': ['woman_genie', 'woman', 'female', 'djinn', 'fantasy', 'women'],
    '🧟': ['zombie', 'dead', 'fantasy', 'undead', 'walking'],
    '🧟‍♂️': ['man_zombie', 'man', 'male', 'dracula', 'undead', 'walking dead', 'fantasy', 'men'],
    '🧟‍♀️': ['woman_zombie', 'woman', 'female', 'undead', 'walking dead', 'fantasy', 'women'],
    '💆': ['person_getting_massage', 'relax', 'face', 'head', 'massaging', 'salon', 'spa'],
    '💆‍♂️': ['man_getting_massage', 'male', 'boy', 'man', 'head', 'face', 'men', 'salon', 'spa'],
    '💆‍♀️': [
    ...
    '🧍‍♀️': ['woman_standing', 'still', 'female', 'stand', 'women'],
    '🧎': ['person_kneeling', 'pray', 'respectful', 'kneel'],
    '🧎‍♂️': ['man_kneeling', 'pray', 'respectful', 'kneel', 'male', 'men'],
    '🧎‍♀️': ['woman_kneeling', 'respectful', 'pray', 'female', 'kneel', 'women'],
    '🧑‍🦯': ['person_with_probing_cane', 'blind', 'accessibility', 'white'],
    '👨‍🦯': ['man_with_probing_cane', 'blind', 'accessibility', 'male', 'men', 'white'],
    '👩‍🦯': ['woman_with_probing_cane', 'blind', 'accessibility', 'female', 'white', 'women'],
    '🧑‍🦼': ['person_in_motorized_wheelchair', 'disability', 'accessibility'],
    '👨‍🦼': ['man_in_motorized_wheelchair', 'disability', 'accessibility', 'male', 'men'],
    '👩‍🦼': ['woman_in_motorized_wheelchair', 'disability', 'accessibility', 'female', 'women'],
    '🧑‍🦽': ['person_in_manual_wheelchair', 'disability', 'accessibility'],
    '👨‍🦽': ['man_in_manual_wheelchair', 'disability', 'accessibility', 'male', 'men'],
    '👩‍🦽': ['woman_in_manual_wheelchair', 'disability', 'accessibility', 'female', 'women'],
    '🏃': ['person_running', 'move', 'exercise', 'jogging', 'marathon', 'run', 'runner', 'workout'],
    '🏃‍♂️': [
        'man_running',
        'man',
        'walking',
    ...
    '🏌️': ['person_golfing', 'sports', 'business', 'ball', 'club', 'golf', 'golfer'],
    '🏌️‍♂️': ['man_golfing', 'sport', 'ball', 'golf', 'golfer', 'male', 'men'],
    '🏌️‍♀️': [
        'woman_golfing',
        'sports',
        'business',
    ...
    '🤼': ['people_wrestling', 'sport', 'wrestle', 'wrestler', 'wrestlers'],
    '🤼‍♂️': ['men_wrestling', 'sports', 'wrestlers', 'male', 'man', 'wrestle', 'wrestler'],
    '🤼‍♀️': ['women_wrestling', 'sports', 'wrestlers', 'female', 'woman', 'wrestle', 'wrestler'],
    '🤽': ['person_playing_water_polo', 'sport'],
    '🤽‍♂️': ['man_playing_water_polo', 'sports', 'pool', 'male', 'men'],
    '🤽‍♀️': ['woman_playing_water_polo', 'sports', 'pool', 'female', 'women'],
    '🤾': ['person_playing_handball', 'sport', 'ball'],
    '🤾‍♂️': ['man_playing_handball', 'sports', 'ball', 'male', 'men'],
    '🤾‍♀️': ['woman_playing_handball', 'sports', 'ball', 'female', 'women'],
    '🤹': ['person_juggling', 'performance', 'balance', 'juggle', 'juggler', 'multitask', 'skill'],
    '🤹‍♂️': ['man_juggling', 'juggle', 'balance', 'skill', 'multitask', 'juggler', 'male', 'men'],
    '🤹‍♀️': [
        'woman_juggling',
        'juggle',
        'balance',
    ...
    '🦮': ['guide_dog', 'animal', 'blind', 'accessibility', 'eye', 'seeing'],
    '🐕‍🦺': ['service_dog', 'blind', 'animal', 'accessibility', 'assistance'],
    ...
    '🐰': ['rabbit_face', 'animal', 'nature', 'pet', 'spring', 'magic', 'bunny', 'easter'],
    ...
    '🐤': ['baby_chick', 'animal', 'chicken', 'bird', 'yellow'],
    '🐥': ['front_facing_baby_chick', 'animal', 'chicken', 'baby', 'bird', 'hatched', 'standing'],
    ...
    '🐠': ['tropical_fish', 'animal', 'swim', 'ocean', 'beach', 'nemo', 'blue', 'yellow'],
    ...
    '🐞': ['lady_beetle', 'animal', 'insect', 'nature', 'ladybug', 'bug', 'ladybird'],
    '🦗': ['cricket', 'animal', 'chirp', 'grasshopper', 'insect', 'orthoptera'],
    '🕷️': ['spider', 'animal', 'arachnid', 'insect'],
    '🕸️': ['spider_web', 'animal', 'insect', 'arachnid', 'silk', 'cobweb', 'spiderweb'],
    ...
    '🥀': ['wilted_flower', 'plant', 'nature', 'flower', 'rose', 'dead', 'drooping'],
    ...
    '🍀': ['four_leaf_clover', 'vegetable', 'plant', 'nature', 'lucky', 'irish', 'ireland', 'luck'],
    '🍁': [
        'maple_leaf',
        'nature',
        'plant',
    ...
    '🍎': ['red_apple', 'fruit', 'mac', 'school', 'delicious', 'plant'],
    '🍏': ['green_apple', 'fruit', 'nature', 'delicious', 'golden', 'granny', 'plant', 'smith'],
    ...
    '🥝': ['kiwi_fruit', 'fruit', 'food', 'chinese', 'gooseberry', 'kiwifruit'],
    ...
    '🌽': ['ear_of_corn', 'food', 'vegetable', 'plant', 'cob', 'maize', 'maze'],
    '🌶️': ['hot_pepper', 'food', 'spicy', 'chilli', 'chili', 'plant'],
    ...
    '🍖': ['meat_on_bone', 'good', 'food', 'drumstick', 'barbecue', 'bbq', 'manga'],
    '🍗': ['poultry_leg', 'food', 'meat', 'drumstick', 'bird', 'chicken', 'turkey', 'bone'],
    '🥩': ['cut_of_meat', 'food', 'cow', 'meat', 'cut', 'chop', 'lambchop', 'porkchop', 'steak'],
    '🥓': ['bacon', 'food', 'breakfast', 'pork', 'pig', 'meat', 'brunch', 'rashers'],
    '🍔': ['hamburger', 'meat', 'fast food', 'beef', 'cheeseburger', 'mcdonalds', 'burger king'],
    '🍟': ['french_fries', 'chips', 'snack', 'fast food', 'potato', "mcdonald's"],
    '🍕': ['pizza', 'food', 'party', 'italy', 'cheese', 'pepperoni', 'slice'],
    '🌭': ['hot_dog', 'food', 'frankfurter', 'america', 'hotdog', 'redhot', 'sausage', 'wiener'],
    '🥪': [
        'sandwich',
        'food',
        'lunch',
    ...
    '🥘': ['shallow_pan_of_food', 'food', 'cooking', 'casserole', 'paella', 'skillet', 'curry'],
    '🍲': ['pot_of_food', 'food', 'meat', 'soup', 'hot pot', 'bowl', 'stew'],
    '🥣': [
        'bowl_with_spoon',
        'food',
        'breakfast',
    ...
    '🍫': ['chocolate_bar', 'food', 'snack', 'dessert', 'sweet', 'candy'],
    ...
    '🍯': ['honey_pot', 'bees', 'sweet', 'kitchen', 'honeypot'],
    '🍼': ['baby_bottle', 'food', 'container', 'milk', 'drink', 'feeding'],
    ...
    '🌎': ['globe_showing_americas', 'globe', 'world', 'USA', 'earth', 'international', 'planet'],
    '🌏': [
    ...
    '🗻': ['mount_fuji', 'photo', 'mountain', 'nature', 'japanese', 'capped', 'san', 'snow'],
    ...
    '🏗️': ['building_construction', 'wip', 'working', 'progress', 'crane'],
    ...
    '🏢': ['office_building', 'building', 'bureau', 'work', 'city', 'high', 'rise'],
    '🏣': [
    ...
    '🏯': ['japanese_castle', 'photo', 'building', 'fortress'],
    ...
    '⛩️': ['shinto_shrine', 'temple', 'japan', 'kyoto', 'kami', 'michi', 'no', 'religion'],
    ...
    '🚞': ['mountain_railway', 'transportation', 'vehicle', 'car', 'funicular', 'train'],
    '🚋': [
        'tram_car',
        'transportation',
        'vehicle',
    ...
    '🚒': ['fire_engine', 'transportation', 'cars', 'vehicle', 'department', 'truck'],
    '🚓': [
        'police_car',
        'vehicle',
        'cars',
    ...
    '🚘': ['oncoming_automobile', 'car', 'vehicle', 'transportation', 'front'],
    '🚙': [
    ...
    '🛥️': ['motor_boat', 'ship', 'motorboat', 'vehicle'],
    ...
    '🛩️': ['small_airplane', 'flight', 'transportation', 'fly', 'vehicle', 'aeroplane', 'plane'],
    '🛫': [
        'airplane_departure',
        'airport',
        'flight',
    ...
    '🚠': ['mountain_cableway', 'transportation', 'vehicle', 'ski', 'cable', 'gondola'],
    '🚡': [
        'aerial_tramway',
        'transportation',
        'vehicle',
    ...
    '🌥️': ['sun_behind_large_cloud', 'weather', 'white'],
    '🌦️': ['sun_behind_rain_cloud', 'weather', 'white'],
    '🌧️': ['cloud_with_rain', 'weather'],
    '🌨️': ['cloud_with_snow', 'weather', 'cold'],
    '🌩️': ['cloud_with_lightning', 'weather', 'thunder'],
    '🌪️': ['tornado', 'weather', 'cyclone', 'twister', 'cloud', 'whirlwind'],
    '🌫️': ['fog', 'weather', 'cloud'],
    '🌬️': ['wind_face', 'gust', 'air', 'blow', 'blowing', 'cloud', 'mother', 'nature', 'weather'],
    '🌀': [
        'cyclone',
        'weather',
        'swirl',
    ...
    '⛱️': ['umbrella_on_ground', 'weather', 'summer', 'beach', 'parasol', 'rain', 'sun'],
    '⚡': [
        'high_voltage',
        'thunder',
        'weather',
    ...
    '🥈': ['2nd_place_medal', 'award', 'second', 'silver'],
    '🥉': ['3rd_place_medal', 'award', 'third', 'bronze'],
    ...
    '🏈': ['american_football', 'sports', 'balls', 'NFL', 'ball', 'gridiron', 'superbowl'],
    '🏉': ['rugby_football', 'sports', 'team', 'ball', 'league', 'union'],
    '🎾': ['tennis', 'sports', 'balls', 'green', 'ball', 'racket', 'racquet'],
    '🥏': ['flying_disc', 'sports', 'frisbee', 'ultimate', 'game', 'golf', 'sport'],
    '🎳': ['bowling', 'sports', 'fun', 'play', 'ball', 'game', 'pin', 'pins', 'skittles', 'ten'],
    '🏏': ['cricket_game', 'sports', 'ball', 'bat', 'field'],
    '🏑': ['field_hockey', 'sports', 'ball', 'game', 'stick'],
    '🏒': ['ice_hockey', 'sports', 'game', 'puck', 'stick'],
    '🥍': ['lacrosse', 'sports', 'ball', 'stick', 'game', 'goal', 'sport'],
    '🏓': ['ping_pong', 'sports', 'pingpong', 'ball', 'bat', 'game', 'paddle', 'table', 'tennis'],
    '🏸': ['badminton', 'sports', 'birdie', 'game', 'racquet', 'shuttlecock'],
    '🥊': ['boxing_glove', 'sports', 'fighting'],
    '🥋': ['martial_arts_uniform', 'judo', 'karate', 'taekwondo'],
    '🥅': ['goal_net', 'sports'],
    '⛳': ['flag_in_hole', 'sports', 'business', 'flag', 'hole', 'summer', 'golf'],
    '⛸️': ['ice_skate', 'sports', 'skating'],
    '🎣': ['fishing_pole', 'food', 'hobby', 'summer', 'entertainment', 'fish', 'rod'],
    '🤿': ['diving_mask', 'sport', 'ocean', 'scuba', 'snorkeling'],
    '🎽': ['running_shirt', 'play', 'pageant', 'athletics', 'marathon', 'sash', 'singlet'],
    '🎿': ['skis', 'sports', 'winter', 'cold', 'snow', 'boot', 'ski', 'skiing'],
    '🛷': ['sled', 'sleigh', 'luge', 'toboggan', 'sledge'],
    '🥌': ['curling_stone', 'sports', 'game', 'rock'],
    '🎯': [
        'direct_hit',
        'game',
        'play',
    ...
    '🧸': ['teddy_bear', 'plush', 'stuffed', 'plaything', 'toy'],
    '♠️': ['spade_suit', 'poker', 'cards', 'suits', 'magic', 'black', 'card', 'game', 'spades'],
    '♥️': ['heart_suit', 'poker', 'cards', 'magic', 'suits', 'black', 'card', 'game', 'hearts'],
    '♦️': ['diamond_suit', 'poker', 'cards', 'magic', 'suits', 'black', 'card', 'diamonds', 'game'],
    '♣️': ['club_suit', 'poker', 'cards', 'magic', 'suits', 'black', 'card', 'clubs', 'game'],
    '♟️': ['chess_pawn', 'expendable', 'black', 'dupe', 'game', 'piece'],
    '🃏': [
        'joker',
        'poker',
        'cards',
    ...
    '🥼': ['lab_coat', 'doctor', 'experiment', 'scientist', 'chemist', 'clothing'],
    '🦺': ['safety_vest', 'protection', 'emergency'],
    '👔': [
        'necktie',
        'shirt',
        'suitup',
    ...
    '👞': ['man_s_shoe', 'fashion', 'male', 'brown', 'clothing', 'dress', 'mans', 'man’s'],
    '👟': [
        'running_shoe',
        'shoes',
        'sports',
    ...
    '📠': ['fax_machine', 'communication', 'technology', 'facsimile'],
    '🔋': ['battery', 'power', 'energy', 'sustain', 'aa', 'phone'],
    '🔌': ['electric_plug', 'charger', 'power', 'ac', 'adaptor', 'cable', 'electricity'],
    '💻': [
        'laptop',
        'technology',
        'screen',
    ...
    '🖱️': ['computer_mouse', 'click', 'button', 'three'],
    ...
    '📹': ['video_camera', 'film', 'record', 'camcorder', 'entertainment'],
    '📼': [
        'videocassette',
        'record',
        'video',
    ...
    '📄': ['page_facing_up', 'documents', 'office', 'paper', 'information', 'document', 'printed'],
    '📰': ['newspaper', 'press', 'headline', 'communication', 'news', 'paper'],
    '🗞️': ['rolled_up_newspaper', 'press', 'headline', 'delivery', 'news', 'paper', 'roll'],
    '📑': ['bookmark_tabs', 'favorite', 'save', 'order', 'tidy', 'mark', 'marker'],
    ...
    '📧': ['e_mail', 'communication', 'inbox', 'email', 'letter', 'symbol'],
    '📨': [
        'incoming_envelope',
        'email',
        'inbox',
    ...
    '📆': ['tear_off_calendar', 'schedule', 'date', 'planning', 'day', 'desk'],
    '🗒️': ['spiral_notepad', 'memo', 'stationery', 'note', 'pad'],
    '🗓️': ['spiral_calendar', 'date', 'schedule', 'planning', 'pad'],
    '📇': ['card_index', 'business', 'stationery', 'rolodex', 'system'],
    '📈': [
        'chart_increasing',
        'graph',
        'presentation',
    ...
    '📍': ['round_pushpin', 'stationery', 'location', 'map', 'here', 'dropped', 'pin', 'red'],
    '📎': ['paperclip', 'documents', 'stationery', 'clippy'],
    '🖇️': ['linked_paperclips', 'documents', 'stationery', 'communication', 'link', 'paperclip'],
    '📏': [
        'straight_ruler',
        'stationery',
        'calculate',
    ...
    '🗝️': ['old_key', 'lock', 'door', 'password', 'clue'],
    '🔨': ['hammer', 'tools', 'build', 'create', 'claw', 'handyman', 'tool'],
    '🪓': ['axe', 'tool', 'chop', 'cut', 'hatchet', 'split', 'wood'],
    '⛏️': ['pick', 'tools', 'dig', 'mining', 'pickaxe', 'tool'],
    '⚒️': ['hammer_and_pick', 'tools', 'build', 'create', 'tool'],
    '🛠️': ['hammer_and_wrench', 'tools', 'build', 'create', 'spanner', 'tool'],
    ...
    '🔩': ['nut_and_bolt', 'handy', 'tools', 'fix', 'screw', 'tool'],
    ...
    '🧪': ['test_tube', 'chemistry', 'experiment', 'lab', 'science', 'chemist'],
    '🧫': ['petri_dish', 'bacteria', 'biology', 'culture', 'lab', 'biologist'],
    ...
    '🛋️': ['couch_and_lamp', 'read', 'chill', 'hotel', 'lounge', 'settee', 'sofa'],
    ...
    '🛂': ['passport_control', 'custom', 'blue-square', 'border'],
    ...
    '🔛': ['on_arrow', 'arrow', 'words', 'above', 'exclamation', 'left', 'mark', 'on!', 'right'],
    '🔜': ['soon_arrow', 'arrow', 'words', 'above', 'rightwards'],
    '🔝': ['top_arrow', 'words', 'blue-square', 'above', 'up', 'upwards'],
    '🛐': ['place_of_worship', 'religion', 'church', 'temple', 'prayer', 'building', 'religious'],
    '⚛️': ['atom_symbol', 'science', 'physics', 'chemistry', 'atheist'],
    '🕉️': [
        'om',
        'hinduism',
        'buddhism',
    ...
    '☦️': ['orthodox_cross', 'suppedaneum', 'religion', 'christian'],
    '☪️': ['star_and_crescent', 'islam', 'muslim', 'religion'],
    '☮️': ['peace_symbol', 'hippie', 'sign'],
    '🕎': [
        'menorah',
        'hanukkah',
        'candles',
    ...
    '⏺️': ['record_button', 'blue-square', 'black', 'circle', 'for', 'symbol'],
    '⏏️': ['eject_button', 'blue-square', 'symbol'],
    '🎦': [
        'cinema',
        'blue-square',
        'record',
    ...
    '📛': ['name_badge', 'fire', 'forbid', 'tag', 'tofu'],
    '🔰': [
    ...
    '➖': ['minus_sign', 'math', 'calculation', 'subtract', 'less', 'heavy', 'symbol'],
    '➗': ['division_sign', 'divide', 'math', 'calculation', 'heavy', 'symbol'],
    '➰': ['curly_loop', 'scribble', 'draw', 'shape', 'squiggle', 'curl', 'curling'],
    '➿': ['double_curly_loop', 'tape', 'cassette', 'curl', 'curling', 'voicemail'],
    '〽️': [
    ...
    '‼️': ['double_exclamation_mark', 'exclamation', 'surprise', 'bangbang', 'punctuation', 'red'],
    '⁉️': ['exclamation_question_mark', 'wat', 'punctuation', 'surprise', 'interrobang', 'red'],
    '❓': ['question_mark', 'doubt', 'confused', 'black', 'ornament', 'punctuation', 'red'],
    '❔': [
        'white_question_mark',
        'doubts',
        'gray',
    ...
    '™️': ['trade_mark', 'trademark', 'brand', 'law', 'legal', 'sign', 'tm'],
    '#️⃣': [
        'keycap_',
        'symbol',
        'blue-square',
    ...
    '1️⃣': ['keycap_1', 'blue-square', 'numbers', '1', 'one', 'digit'],
    '2️⃣': ['keycap_2', 'numbers', '2', 'prime', 'blue-square', 'two', 'digit'],
    '3️⃣': ['keycap_3', '3', 'numbers', 'prime', 'blue-square', 'three', 'digit'],
    '4️⃣': ['keycap_4', '4', 'numbers', 'blue-square', 'four', 'digit'],
    '5️⃣': ['keycap_5', '5', 'numbers', 'blue-square', 'prime', 'five', 'digit'],
    '6️⃣': ['keycap_6', '6', 'numbers', 'blue-square', 'six', 'digit'],
    '7️⃣': ['keycap_7', '7', 'numbers', 'blue-square', 'prime', 'seven', 'digit'],
    '8️⃣': ['keycap_8', '8', 'blue-square', 'numbers', 'eight', 'digit'],
    '9️⃣': ['keycap_9', 'blue-square', 'numbers', '9', 'nine', 'digit'],
    '🔟': ['keycap_10', 'numbers', '10', 'blue-square', 'ten', 'number'],
    '🔠': [
    ...
    '🆓': ['free_button', 'blue-square', 'words', 'sign', 'squared'],
    ℹ️: [
        'information',
        'blue-square',
        'alphabet',
    ...
    '🆕': ['new_button', 'blue-square', 'words', 'start', 'fresh', 'sign', 'squared'],
    '🆖': [
        'ng_button',
        'blue-square',
        'words',
    ...
    '🟡': ['yellow_circle', 'round', 'geometric', 'large'],
    '🟢': ['green_circle', 'round', 'geometric', 'large'],
    '🔵': ['blue_circle', 'shape', 'icon', 'button', 'geometric', 'large'],
    '🟣': ['purple_circle', 'round', 'geometric', 'large'],
    '🟤': ['brown_circle', 'round', 'geometric', 'large'],
    '⚫': ['black_circle', 'shape', 'button', 'round', 'geometric', 'medium'],
    '⚪': ['white_circle', 'shape', 'round', 'geometric', 'medium'],
    '🟥': ['red_square', 'card', 'geometric', 'large'],
    '🟧': ['orange_square', 'geometric', 'large'],
    '🟨': ['yellow_square', 'card', 'geometric', 'large'],
    '🟩': ['green_square', 'geometric', 'large'],
    '🟦': ['blue_square', 'geometric', 'large'],
    '🟪': ['purple_square', 'geometric', 'large'],
    '🟫': ['brown_square', 'geometric', 'large'],
    '⬛': ['black_large_square', 'shape', 'icon', 'button', 'geometric'],
    '⬜': ['white_large_square', 'shape', 'icon', 'stone', 'button', 'geometric'],
    '◼️': ['black_medium_square', 'shape', 'button', 'icon', 'geometric'],
    '◻️': ['white_medium_square', 'shape', 'stone', 'icon', 'geometric'],
    '◾': ['black_medium_small_square', 'icon', 'shape', 'button', 'geometric'],
    '◽': ['white_medium_small_square', 'shape', 'stone', 'icon', 'button', 'geometric'],
    '▪️': ['black_small_square', 'shape', 'icon', 'geometric'],
    '▫️': ['white_small_square', 'shape', 'icon', 'geometric'],
    '🔶': ['large_orange_diamond', 'shape', 'jewel', 'gem', 'geometric'],
    '🔷': ['large_blue_diamond', 'shape', 'jewel', 'gem', 'geometric'],
    '🔸': ['small_orange_diamond', 'shape', 'jewel', 'gem', 'geometric'],
    '🔹': ['small_blue_diamond', 'shape', 'jewel', 'gem', 'geometric'],
    '🔺': [
    ...
    '🔲': ['black_square_button', 'shape', 'input', 'frame', 'geometric'],
    '🏁': [
        'chequered_flag',
        'contest',
        'finishline',
    ...
    '🇦🇲': ['flag_armenia', 'am', 'flag', 'nation', 'country', 'banner', 'armenia', 'armenian'],
    '🇦🇴': ['flag_angola', 'ao', 'flag', 'nation', 'country', 'banner', 'angola', 'angolan'],
    '🇦🇶': [
        'flag_antarctica',
        'aq',
        'flag',
    ...
    '🇧🇼': ['flag_botswana', 'bw', 'flag', 'nation', 'country', 'banner', 'botswana', 'batswana'],
    '🇧🇾': ['flag_belarus', 'by', 'flag', 'nation', 'country', 'banner', 'belarus', 'belarusian'],
    '🇧🇿': ['flag_belize', 'bz', 'flag', 'nation', 'country', 'banner', 'belize', 'belizean'],
    '🇨🇦': ['flag_canada', 'ca', 'flag', 'nation', 'country', 'banner', 'canada', 'canadian'],
    '🇨🇨': [
        'flag_cocos_islands',
        'cocos',
        'keeling',
    ...
    '🇩🇰': ['flag_denmark', 'dk', 'flag', 'nation', 'country', 'banner', 'denmark', 'danish'],
    ...
    '🇪🇦': ['flag_ceuta_melilla'],
    '🇪🇨': ['flag_ecuador', 'ec', 'flag', 'nation', 'country', 'banner', 'ecuador', 'ecuadorian'],
    '🇪🇪': ['flag_estonia', 'ee', 'flag', 'nation', 'country', 'banner', 'estonia', 'estonian'],
    '🇪🇬': ['flag_egypt', 'eg', 'flag', 'nation', 'country', 'banner', 'egypt', 'egyptian'],
    '🇪🇭': [
        'flag_western_sahara',
        'western',
        'sahara',
    ...
    '🇫🇮': ['flag_finland', 'fi', 'flag', 'nation', 'country', 'banner', 'finland', 'finnish'],
    '🇫🇯': ['flag_fiji', 'fj', 'flag', 'nation', 'country', 'banner', 'fiji', 'fijian'],
    '🇫🇰': [
    ...
    '🇭🇷': ['flag_croatia', 'hr', 'flag', 'nation', 'country', 'banner', 'croatia', 'croatian'],
    '🇭🇹': ['flag_haiti', 'ht', 'flag', 'nation', 'country', 'banner', 'haiti', 'haitian'],
    '🇭🇺': ['flag_hungary', 'hu', 'flag', 'nation', 'country', 'banner', 'hungary', 'hungarian'],
    '🇮🇨': [
        'flag_canary_islands',
        'canary',
        'islands',
    ...
    '🇮🇱': ['flag_israel', 'il', 'flag', 'nation', 'country', 'banner', 'israel', 'israeli'],
    '🇮🇲': [
        'flag_isle_of_man',
        'isle',
        'man',
    ...
    '🇯🇴': ['flag_jordan', 'jo', 'flag', 'nation', 'country', 'banner', 'jordan', 'jordanian'],
    '🇯🇵': [
        'flag_japan',
        'japanese',
        'nation',
    ...
    '🇰🇲': ['flag_comoros', 'km', 'flag', 'nation', 'country', 'banner', 'comoros', 'comoran'],
    '🇰🇳': [
        'flag_st_kitts_nevis',
        'saint',
        'kitts',
    ...
    '🇲🇦': ['flag_morocco', 'ma', 'flag', 'nation', 'country', 'banner', 'morocco', 'moroccan'],
    '🇲🇨': ['flag_monaco', 'mc', 'flag', 'nation', 'country', 'banner', 'monaco', 'monégasque'],
    '🇲🇩': [
        'flag_moldova',
        'moldova',
        'republic',
    ...
    '🇲🇻': ['flag_maldives', 'mv', 'flag', 'nation', 'country', 'banner', 'maldives', 'maldivian'],
    '🇲🇼': ['flag_malawi', 'mw', 'flag', 'nation', 'country', 'banner', 'malawi', 'malawian flag'],
    '🇲🇽': ['flag_mexico', 'mx', 'flag', 'nation', 'country', 'banner', 'mexico', 'mexican'],
    '🇲🇾': ['flag_malaysia', 'my', 'flag', 'nation', 'country', 'banner', 'malaysia', 'malaysian'],
    '🇲🇿': [
        'flag_mozambique',
        'mz',
        'flag',
    ...
    '🇳🇺': ['flag_niue', 'nu', 'flag', 'nation', 'country', 'banner', 'niue', 'niuean'],
    '🇳🇿': [
        'flag_new_zealand',
        'new',
        'zealand',
    ...
    '🇵🇪': ['flag_peru', 'pe', 'flag', 'nation', 'country', 'banner', 'peru', 'peruvian'],
    '🇵🇫': [
    ...
    '🇵🇱': ['flag_poland', 'pl', 'flag', 'nation', 'country', 'banner', 'poland', 'polish'],
    '🇵🇲': [
    ...
    '🇵🇾': ['flag_paraguay', 'py', 'flag', 'nation', 'country', 'banner', 'paraguay', 'paraguayan'],
    '🇶🇦': ['flag_qatar', 'qa', 'flag', 'nation', 'country', 'banner', 'qatar', 'qatari'],
    '🇷🇪': [
        'flag_reunion',
        'réunion',
        'flag',
    ...
    '🇸🇷': ['flag_suriname', 'sr', 'flag', 'nation', 'country', 'banner', 'suriname', 'surinamer'],
    '🇸🇸': [
        'flag_south_sudan',
        'south',
        'sd',
    ...
    '🇹🇯': ['flag_tajikistan', 'tj', 'flag', 'nation', 'country', 'banner', 'tajikistan', 'tajik'],
    '🇹🇰': ['flag_tokelau', 'tk', 'flag', 'nation', 'country', 'banner', 'tokelau', 'tokelauan'],
    '🇹🇱': [
        'flag_timor_leste',
        'timor',
        'leste',
    ...
    '🇹🇴': ['flag_tonga', 'to', 'flag', 'nation', 'country', 'banner', 'tonga', 'tongan flag'],
    '🇹🇷': [
        'flag_turkey',
        'turkey',
        'flag',
    ...
    '🇺🇲': ['flag_u_s_outlying_islands', 'u.s.', 'us'],
    ...
    '🇾🇪': ['flag_yemen', 'ye', 'flag', 'nation', 'country', 'banner', 'yemen', 'yemeni flag'],
    ...
    '🏴󠁧󠁢󠁷󠁬󠁳󠁿': ['flag_wales', 'flag', 'welsh', 'baner', 'cymru', 'ddraig', 'dragon', 'goch', 'red', 'y'],
    '🥲': [
