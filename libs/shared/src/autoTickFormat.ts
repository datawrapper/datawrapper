 ...
 */
export function autoTickFormatNumber(range: [number, number]) {
 ...
 */
export function autoTickFormatDate(range: [Date, Date], precision: DatePrecision = 'day') {
...
export function autoTickFormat(column: Column, range: [any, any]) {
