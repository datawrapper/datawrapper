...
class DatawrapperPlugin_VisualizationLineChart extends DatawrapperPlugin_Visualization {
    ...
    public function getOptions(){
        ...
        $options = array(
            ...
            "connect-missing-values" => array(
                ...
                "label" => __("Force a baseline at zero"),
            ),
            "extend-range" => array(
                "type" => "checkbox",
    ...
    public function getDemoDataSets(){
        ...
        $datasets[] = array(
            ...
            'title' => __('Youth Unemployment in Europe', $id),
            'type' => __('Line chart', $id),
            'presets' => array(
                'type' => 'line-chart',
...
"
        ...
        $datasets[] = array(
            'id' => 'us-trade',
            'title' => __('US Trade with United Kingdom', $id),
            'type' => __('Line chart', $id),
            'presets' => array(
                'type' => 'line-chart',
...
2011\t52260.822\t56998.314"
        ...
        $datasets[] = array(
            'id' => 'marriages',
            'title' => __('Marriages in Germany', $id),
            'chartid' => '',
            'type' => __('Line chart', $id),
            'presets' => array(
                'type' => 'line-chart',
            ...
            'data' => __('Year', $id)."\t".__('Marriages', $id)."\n1946\t8.1\n1947\t9.8\n1948\t10.5\n1949\t10.2\n1950\t11.0\n1951\t10.4\n1952\t9.5\n1953\t8.9\n1954\t8.7\n1955\t8.8\n1956\t8.9\n1957\t8.9\n1958\t9.1\n1959\t9.2\n1960\t9.5\n1961\t9.5\n1962\t9.4\n1963\t8.8\n1964\t8.5\n1965\t8.2\n1966\t8.0\n1967\t7.9\n1968\t7.3\n1969\t7.4\n1970\t7.4\n1971\t7.2\n1972\t7.0\n1973\t6.7\n1974\t6.5\n1975\t6.7\n1976\t6.5\n1977\t6.5\n1978\t6.0\n1979\t6.2\n1980\t6.3\n1981\t6.2\n1982\t6.2\n1983\t6.3\n1984\t6.4\n1985\t6.4\n1986\t6.6\n1987\t6.7\n1988\t6.8\n1989\t6.7\n1990\t6.5\n1991\t5.7\n1992\t5.6\n1993\t5.5\n1994\t5.4\n1995\t5.3\n1996\t5.2\n1997\t5.2\n1998\t5.1\n1999\t5.2\n2000\t5.1\n2001\t4.7\n2002\t4.8\n2003\t4.6\n2004\t4.8\n2005\t4.7\n2006\t4.5\n2007\t4.5\n2008\t4.6\n2009\t4.6\n2010\t4.7\n2011\t4.6"
        );
        return $datasets;
    }
}
